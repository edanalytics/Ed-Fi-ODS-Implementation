...
COMMENT ON COLUMN vt.StudentCTEProgramAssociationExtension.CTECourseCode IS 'A unique alphanumeric code assigned to a course.';
COMMENT ON COLUMN vt.StudentCTEProgramAssociationExtension.CTECourseEducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN vt.StudentCTEProgramAssociationExtension.CTEProgramCompletionIndicator IS 'Indicates student has met all requirements for CTE Program completion.';
...
COMMENT ON COLUMN vt.StudentCTEProgramAssociationExtension.SecondProgramSemesterEnrollment IS 'Indicates student is enrolled in the CTE Program for their second semester.';
