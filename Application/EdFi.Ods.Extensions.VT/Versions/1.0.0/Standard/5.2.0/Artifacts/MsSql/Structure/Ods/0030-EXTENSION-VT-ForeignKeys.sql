...
ALTER TABLE [vt].[StudentCTEProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentCTEProgramAssociationExtension_Course] FOREIGN KEY ([CTECourseCode], [CTECourseEducationOrganizationId])
...
ON [vt].[StudentCTEProgramAssociationExtension] ([CTECourseCode] ASC, [CTECourseEducationOrganizationId] ASC)
GO
