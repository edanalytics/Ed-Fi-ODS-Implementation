...
CREATE TABLE tx.ActualExt (
    ...
    FiscalYear DECIMAL(1, 0) NOT NULL,
    FunctionDescriptorId INT NOT NULL,
    FundDescriptorId INT NOT NULL,
    ObjectDescriptorId INT NOT NULL,
    Organization DECIMAL(3, 0) NOT NULL,
    ProgramIntentDescriptorId INT NOT NULL,
    ActualAmount DECIMAL(11, 0) NOT NULL,
    Discriminator VARCHAR(128) NULL,
    CreateDate TIMESTAMP NOT NULL,
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT ActualExt_PK PRIMARY KEY (EducationOrganizationId, FiscalYear, FunctionDescriptorId, FundDescriptorId, ObjectDescriptorId, Organization, ProgramIntentDescriptorId)
); 
...
CREATE TABLE tx.BasicReportingPeriodAttendance (
    ...
    NumberDaysTaught DECIMAL(3, 0) NOT NULL,
...
CREATE TABLE tx.BudgetExt (
    ...
    Organization DECIMAL(3, 0) NOT NULL,
    ProgramIntentDescriptorId INT NOT NULL,
    BudgetAmount DECIMAL(11, 0) NOT NULL,
    Discriminator VARCHAR(128) NULL,
    CreateDate TIMESTAMP NOT NULL,
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT BudgetExt_PK PRIMARY KEY (EducationOrganizationId, FiscalYear, FunctionDescriptorId, FundDescriptorId, ObjectDescriptorId, Organization, ProgramIntentDescriptorId)
); 
...
CREATE TABLE tx.CalendarDateExtension (
    ...
    SchoolDayOperationalMinutes DECIMAL(3, 0) NULL,
    SchoolDayInstructionalMinutes DECIMAL(3, 0) NULL,
    SchoolDayWaiverMinutes DECIMAL(3, 0) NULL,
    CreateDate TIMESTAMP NOT NULL,
...
CREATE TABLE tx.CourseTranscriptExtension (
    ...
    CollegeCreditHours DECIMAL(1, 0) NULL,
...
CREATE TABLE tx.DisciplineActionExtension (
    ...
    StudentUSI INT NOT NULL,
    ActualLengthOfDisciplinaryAssignment DECIMAL(3, 0) NULL,
    OfficialLengthOfDisciplinaryAssignment DECIMAL(3, 0) NULL,
...
CREATE TABLE tx.FlexibleCTEProgramReportingPeriodAttendance (
    ...
    StudentUSI INT NOT NULL,
    NumberDaysTaught DECIMAL(3, 0) NOT NULL,
    FlexAttendTotalCareerTechMinutesPresent DECIMAL(5, 0) NOT NULL,
    Discriminator VARCHAR(128) NULL,
    CreateDate TIMESTAMP NOT NULL,
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
...
CREATE TABLE tx.FlexibleRegularProgramReportingPeriodAttendance (
    ...
    StudentUSI INT NOT NULL,
    NumberDaysTaught DECIMAL(3, 0) NOT NULL,
    FlexAttendTotalEligibleMinutesPresent DECIMAL(5, 0) NOT NULL,
    FlexAttendTotalIneligibleMinutesPresent DECIMAL(5, 0) NOT NULL,
...
CREATE TABLE tx.FlexibleSpecialEducationProgramReportingPeriodAttendance (
    ...
    FlexAttendExcessMinutesInInstrSetting DECIMAL(5, 0) NOT NULL,
    Discriminator VARCHAR(128) NULL,
    CreateDate TIMESTAMP NOT NULL,
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
...
CREATE TABLE tx.HearingAmplifAvgDailyUseDescriptor (
    ...
    CONSTRAINT HearingAmplifAvgDailyUseDescriptor_PK PRIMARY KEY (HearingAmplifAvgDailyUseDescriptorId)
); 
...
CREATE TABLE tx.LocalEducationAgencyChildCareOperationNumber (
    ChildCareOperationNumber VARCHAR(8) NOT NULL,
    LocalEducationAgencyId INT NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT LocalEducationAgencyChildCareOperationNumber_PK PRIMARY KEY (ChildCareOperationNumber, LocalEducationAgencyId)
); 
ALTER TABLE tx.LocalEducationAgencyChildCareOperationNumber ALTER COLUMN CreateDate SET DEFAULT current_timestamp;

-- Table tx.LocalEducationAgencyExtension --
CREATE TABLE tx.LocalEducationAgencyExtension (
    LocalEducationAgencyId INT NOT NULL,
    TotalNumSchoolBoardRequests DECIMAL(3, 0) NULL,
    TotalCostSchoolBoardRequests DECIMAL(6, 0) NULL,
...
-- Table tx.ModelEntityDescriptor --
CREATE TABLE tx.ModelEntityDescriptor (
...
CREATE TABLE tx.PayrollExt (
    ...
    PayrollAmount DECIMAL(6, 0) NOT NULL,
    Discriminator VARCHAR(128) NULL,
    CreateDate TIMESTAMP NOT NULL,
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT PayrollExt_PK PRIMARY KEY (EducationOrganizationId, FiscalYear, FunctionDescriptorId, FundDescriptorId, ObjectDescriptorId, Organization, PayrollActivityDescriptorId, ProgramIntentDescriptorId, StaffUSI)
); 
...
CREATE TABLE tx.PriorYearLeaverIndustryBasedCertificationSet (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT PriorYearLeaverIndustryBasedCertificationSet_PK PRIMARY KEY (DateCertTaken, IBCVendorDescriptorId, PostSecondaryCertificationLicensureDescriptorId, SchoolId, StudentUId)
); 
...
CREATE TABLE tx.PriorYearLeaverStudentParentAssociation (
    ...
    ContactPriority DECIMAL(2, 0) NULL,
    Discriminator VARCHAR(128) NULL,
    CreateDate TIMESTAMP NOT NULL,
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
...
CREATE TABLE tx.RoleIdDescriptor (
    ...
    CONSTRAINT RoleIdDescriptor_PK PRIMARY KEY (RoleIdDescriptorId)
); 
...
CREATE TABLE tx.SchoolCharterWaitlistSet (
    ...
    CharterEducationalEnrollmentCapacity DECIMAL(4, 0) NOT NULL,
    NumberCharterStudentsEnrolled DECIMAL(4, 0) NOT NULL,
    SchoolId INT NOT NULL,
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT SchoolCharterWaitlistSet_PK PRIMARY KEY (BeginDate, CharterAdmissionWaitlist, CharterEducationalEnrollmentCapacity, NumberCharterStudentsEnrolled, SchoolId)
); 
...
CREATE TABLE tx.SchoolELOSet (
    ...
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT SchoolELOSet_PK PRIMARY KEY (BeginDate, ELOTypeDescriptorId, SchoolId)
); 
...
CREATE TABLE tx.SchoolELOSetELOActivitySet (
    ...
    ELOTypeDescriptorId INT NOT NULL,
    SchoolId INT NOT NULL,
    ELODaysScheduledPerYear DECIMAL(3, 0) NOT NULL,
    ELOMinutesScheduledPerDay DECIMAL(3, 0) NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT SchoolELOSetELOActivitySet_PK PRIMARY KEY (BeginDate, ELOActivityDescriptorId, ELOTypeDescriptorId, SchoolId)
); 
...
CREATE TABLE tx.SchoolExtension (
    ...
    NumberOfBullyingIncidents DECIMAL(5, 0) NULL,
    NumberOfCyberbullyingIncidents DECIMAL(5, 0) NULL,
    ExpandedLearningOpportunity BOOLEAN NULL,
    SchoolDoNotReportTSDS BOOLEAN NULL,
    CreateDate TIMESTAMP NOT NULL,
...
CREATE TABLE tx.SectionSet (
    ...
    SPEDStudentAgeRangeDescriptorId INT NULL,
...
CREATE TABLE tx.ServiceIdDescriptor (
    ...
    CONSTRAINT ServiceIdDescriptor_PK PRIMARY KEY (ServiceIdDescriptorId)
); 
...
CREATE TABLE tx.SharedServiceArrangementExt (
    ...
    FiscalYear DECIMAL(1, 0) NOT NULL,
    FundDescriptorId INT NOT NULL,
    SSAMemberDistrictId DECIMAL(6, 0) NOT NULL,
...
CREATE TABLE tx.SpecialEducationProgramReportingPeriodAttendance (
    ...
    LEAOfRDSPDService DECIMAL(6, 0) NULL,
    Discriminator VARCHAR(128) NULL,
    CreateDate TIMESTAMP NOT NULL,
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
...
CREATE TABLE tx.SSAOrgAssociationExt (
    EducationOrganizationId INT NOT NULL,
    FiscalAgentDistrictId DECIMAL(6, 0) NOT NULL,
    SSATypeDescriptorId INT NOT NULL,
    Discriminator VARCHAR(128) NULL,
    CreateDate TIMESTAMP NOT NULL,
    LastModifiedDate TIMESTAMP NOT NULL,
...
CREATE TABLE tx.StaffEducationOrganizationAssignmentAssociationStaffServiceSet (
    ...
    SPEDStudentAgeRangeDescriptorId INT NULL,
    PopulationServedDescriptorId INT NULL,
    MonthlyMinutes DECIMAL(5, 0) NOT NULL,
...
CREATE TABLE tx.StaffEducationOrganizationEmploymentAssociationExtension (
    ...
    HireDate DATE NOT NULL,
    StaffUSI INT NOT NULL,
    PercentDayEmployed DECIMAL(3, 0) NULL,
    NumberDaysEmployed DECIMAL(3, 0) NULL,
    CreateDate TIMESTAMP NOT NULL,
...
CREATE TABLE tx.StaffExtension (
    StaffUSI INT NOT NULL,
    GenerationCodeDescriptorId INT NULL,
    TotalYearsProfExperience DECIMAL(2, 0) NULL,
    TotalYearsPriorTeachingExperience DECIMAL(2, 0) NULL,
    CreditableYearOfService BOOLEAN NULL,
    YearsExperienceInDistrict DECIMAL(2, 0) NULL,
...
CREATE TABLE tx.StaffParaprofessionalCertificationSet (
    ...
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StaffParaprofessionalCertificationSet_PK PRIMARY KEY (BeginDate, StaffUSI)
); 
...
CREATE TABLE tx.StaffSectionAssociationExtension (
    ...
    SessionName VARCHAR(60) NOT NULL,
    StaffUSI INT NOT NULL,
    NumberOfStudentInClass DECIMAL(3, 0) NULL,
    MonthlyMinutes DECIMAL(5, 0) NULL,
    NumberDaysTaughtWeek1 DECIMAL(1, 0) NULL,
    NumberDaysTaughtWeek2 DECIMAL(1, 0) NULL,
    NumberDaysTaughtWeek3 DECIMAL(1, 0) NULL,
    NumberDaysTaughtWeek4 DECIMAL(1, 0) NULL,
    NumberMinutesTaughtWeek1 DECIMAL(4, 0) NULL,
    NumberMinutesTaughtWeek2 DECIMAL(4, 0) NULL,
    NumberMinutesTaughtWeek3 DECIMAL(4, 0) NULL,
    NumberMinutesTaughtWeek4 DECIMAL(4, 0) NULL,
    SharedServiceArrangementStaffDescriptorId INT NULL,
    CreateDate TIMESTAMP NOT NULL,
...
CREATE TABLE tx.StudentAcademicRecordIndustryBasedCertificationSet (
    ...
    IBCExamFeeAmount DECIMAL(5, 2) NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentAcademicRecordIndustryBasedCertificationSet_PK PRIMARY KEY (DateCertTaken, EducationOrganizationId, IBCVendorDescriptorId, PostSecondaryCertificationLicensureDescriptorId, SchoolYear, StudentUSI, TermDescriptorId)
); 
...
-- Table tx.StudentEducationOrganizationAssociationDyslexiaScreening_f08d12 --
CREATE TABLE tx.StudentEducationOrganizationAssociationDyslexiaScreening_f08d12 (
    BeginDate DATE NOT NULL,
    EducationOrganizationId INT NOT NULL,
    StudentUSI INT NOT NULL,
    DyslexiaScreeningExceptionReasonDescriptorId INT NOT NULL,
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentEducationOrganizationAssociationDyslexiaScr_f08d12_PK PRIMARY KEY (BeginDate, EducationOrganizationId, StudentUSI)
); 
ALTER TABLE tx.StudentEducationOrganizationAssociationDyslexiaScreening_f08d12 ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.StudentEducationOrganizationAssociationLanguageSet (
    ...
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentEducationOrganizationAssociationLanguageSet_PK PRIMARY KEY (BeginDate, EducationOrganizationId, LanguageDescriptorId, StudentUSI)
); 
ALTER TABLE tx.StudentEducationOrganizationAssociationLanguageSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.StudentEducationOrganizationAssociationLanguageSetLanguageUse (
    ...
    StudentUSI INT NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentEducationOrganizationAssociationLanguageSet_9193d3_PK PRIMARY KEY (BeginDate, EducationOrganizationId, LanguageDescriptorId, LanguageUseDescriptorId, StudentUSI)
); 
ALTER TABLE tx.StudentEducationOrganizationAssociationLanguageSetLanguageUse ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.StudentEducationOrganizationAssociationPKFundingSourceSet (
    BeginDate DATE NOT NULL,
    EducationOrganizationId INT NOT NULL,
    OrderOfPKFundingSource DECIMAL(1, 0) NOT NULL,
    StudentUSI INT NOT NULL,
    PKFundingSourceDescriptorId INT NOT NULL,
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
...
CREATE TABLE tx.StudentSpecialEducationProgramAssociationDisabilitySet (
    ...
    OrderOfDisability DECIMAL(1, 0) NULL,
    CreateDate TIMESTAMP NOT NULL,
...
-- Table tx.StudentSpecialEducationProgramAssociationSpecialEducatio_9f4293 --
CREATE TABLE tx.StudentSpecialEducationProgramAssociationSpecialEducatio_9f4293 (
    BeginDate DATE NOT NULL,
    EducationOrganizationId INT NOT NULL,
    EnvironmentBeginDate DATE NOT NULL,
    ProgramEducationOrganizationId INT NOT NULL,
    ProgramName VARCHAR(60) NOT NULL,
    ProgramTypeDescriptorId INT NOT NULL,
    StudentUSI INT NOT NULL,
    EducationalEnvironmentDescriptorId INT NOT NULL,
    EnvironmentEndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentSpecialEducationProgramAssociationSpecialEd_9f4293_PK PRIMARY KEY (BeginDate, EducationOrganizationId, EnvironmentBeginDate, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
); 
ALTER TABLE tx.StudentSpecialEducationProgramAssociationSpecialEducatio_9f4293 ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.StudentSpecialEducationProgramAssociationStudentResident_36c8d7 (
    AttendanceZoneCampus DECIMAL(9, 0) NOT NULL,
    BeginDate DATE NOT NULL,
    ...
    ProgramName VARCHAR(60) NOT NULL,
    ProgramTypeDescriptorId INT NOT NULL,
    ResidentialFacilityId DECIMAL(6, 0) NOT NULL,
    ...
    NumberOtherStudentsAssignedSameSurrogateParent DECIMAL(2, 0) NULL,
    ResidentialFacilityStudentSchoolDayLength DECIMAL(3, 0) NULL,
    CampusIdOfEnrollmentSchoolDayLength DECIMAL(3, 0) NULL,
    CreateDate TIMESTAMP NOT NULL,
...
CREATE TABLE tx.StudentSpecialEducationProgramEligibilityAssociation (
    ...
    EvaluationDelayDays DECIMAL(3, 0) NULL,
