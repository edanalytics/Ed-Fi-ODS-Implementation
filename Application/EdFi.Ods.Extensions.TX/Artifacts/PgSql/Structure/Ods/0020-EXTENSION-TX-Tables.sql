...
CREATE TABLE tx.BasicReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT BasicReportingPeriodAttendance_PK PRIMARY KEY (CalendarCode, GradeLevelDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
...
CREATE TABLE tx.BilingualESLProgramReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT BilingualESLProgramReportingPeriodAttendance_PK PRIMARY KEY (BilingualESLFundingDescriptorId, CalendarCode, GradeLevelDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
...
CREATE TABLE tx.CTEProgramReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT CTEProgramReportingPeriodAttendance_PK PRIMARY KEY (CalendarCode, CTEServiceIdDescriptorId, GradeLevelDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
...
CREATE TABLE tx.FlexibleBilingualESLProgramReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT FlexibleBilingualESLProgramReportingPeriodAttendance_PK PRIMARY KEY (BilingualESLFundingDescriptorId, CalendarCode, FlexAttendanceProgramDescriptorId, GradeLevelDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
...
CREATE TABLE tx.FlexibleCTEProgramReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT FlexibleCTEProgramReportingPeriodAttendance_PK PRIMARY KEY (CalendarCode, FlexAttendanceProgramDescriptorId, GradeLevelDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
...
CREATE TABLE tx.FlexibleRegularProgramReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT FlexibleRegularProgramReportingPeriodAttendance_PK PRIMARY KEY (CalendarCode, FlexAttendanceProgramDescriptorId, GradeLevelDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
...
CREATE TABLE tx.FlexibleSpecialEducationProgramReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT FlexibleSpecialEducationProgramReportingPeriodAttendance_PK PRIMARY KEY (CalendarCode, FlexAttendanceProgramDescriptorId, GradeLevelDescriptorId, InstructionalSettingDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
...
-- Table tx.SectionSetChildCareOperationNumber --
CREATE TABLE tx.SectionSetChildCareOperationNumber (
    BeginDate DATE NOT NULL,
    ...
    SessionName VARCHAR(60) NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT SectionSetChildCareOperationNumber_PK PRIMARY KEY (BeginDate, ChildCareOperationNumber, LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName)
); 
ALTER TABLE tx.SectionSetChildCareOperationNumber ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.SpecialEducationProgramReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT SpecialEducationProgramReportingPeriodAttendance_PK PRIMARY KEY (CalendarCode, GradeLevelDescriptorId, InstructionalSettingDescriptorId, RegionalDaySchoolProgramForDeafDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
...
CREATE TABLE tx.SpecialProgramsReportingPeriodAttendance (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT SpecialProgramsReportingPeriodAttendance_PK PRIMARY KEY (CalendarCode, GradeLevelDescriptorId, SchoolId, StudentUSI, TermDescriptorId)
); 
