...
COMMENT ON TABLE tx.ModelEntityDescriptor IS 'The class of a domain entity in the Ed-Fi data model.';
COMMENT ON COLUMN tx.ModelEntityDescriptor.ModelEntityDescriptorId IS 'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.';
...
COMMENT ON COLUMN tx.PriorYearLeaverParent.ParentUId IS 'A unique alphanumeric code assigned to a parent.';
...
COMMENT ON COLUMN tx.PriorYearLeaverParentAddress.ParentUId IS 'A unique alphanumeric code assigned to a parent.';
...
COMMENT ON COLUMN tx.PriorYearLeaverParentAddressPeriod.ParentUId IS 'A unique alphanumeric code assigned to a parent.';
...
COMMENT ON COLUMN tx.PriorYearLeaverParentElectronicMail.ParentUId IS 'A unique alphanumeric code assigned to a parent.';
...
COMMENT ON COLUMN tx.PriorYearLeaverParentPersonalIdentificationDocument.ParentUId IS 'A unique alphanumeric code assigned to a parent.';
...
COMMENT ON COLUMN tx.PriorYearLeaverParentTelephone.ParentUId IS 'A unique alphanumeric code assigned to a parent.';
...
COMMENT ON COLUMN tx.PriorYearLeaverStudentParentAssociation.ParentUId IS 'A unique alphanumeric code assigned to a parent.';
