...
-- Extended Properties [tx].[ModelEntityDescriptor] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The class of a domain entity in the Ed-Fi data model.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'ModelEntityDescriptor'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'ModelEntityDescriptor', @level2type=N'COLUMN', @level2name=N'ModelEntityDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a parent.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaverParent', @level2type=N'COLUMN', @level2name=N'ParentUId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a parent.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaverParentAddress', @level2type=N'COLUMN', @level2name=N'ParentUId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a parent.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaverParentAddressPeriod', @level2type=N'COLUMN', @level2name=N'ParentUId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a parent.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaverParentElectronicMail', @level2type=N'COLUMN', @level2name=N'ParentUId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a parent.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaverParentPersonalIdentificationDocument', @level2type=N'COLUMN', @level2name=N'ParentUId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a parent.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaverParentTelephone', @level2type=N'COLUMN', @level2name=N'ParentUId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a parent.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaverStudentParentAssociation', @level2type=N'COLUMN', @level2name=N'ParentUId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E0724. StaffService refers to the services supplied by staff.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffEducationOrganizationAssignmentAssociationStaffServiceSet', @level2type=N'COLUMN', @level2name=N'StaffServiceDescriptorId'
GO
