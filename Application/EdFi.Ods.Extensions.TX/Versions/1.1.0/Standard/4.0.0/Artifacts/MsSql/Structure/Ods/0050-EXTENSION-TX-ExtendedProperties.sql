...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3033, C092. Language indicates the language spoken in the student’s home and the language spoken by the student most of the time, as determined by the student’s home language survey. (see 19 TAC §89.1215).', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaverLanguage'
GO
...
-- Extended Properties [tx].[StaffSectionAssociationClassroomPositionSet] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Common Type ClassroomPositionSet is used to add effective date to the element ClassroomPosition.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The local code assigned by the School that identifies the course offering provided for the instruction of students.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'LocalCourseCode'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a school.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'SchoolId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier for the school year.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'SchoolYear'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The local identifier assigned to a section.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'SectionIdentifier'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier for the calendar for the academic session.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'SessionName'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a staff.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'StaffUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3092. ClassroomPositionBeginDate is the first instructional day in the current school year the data element is associated to the Staff.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'ClassroomPositionBeginDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E1454, C309. ClassroomPosition indicates the type of position the staff member holds in the specific class/section; for example: Teacher of Record, Assistant Teacher, Support Teacher, Substitute Teacher.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'ClassroomPositionDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3093. ClassroomPositionEndDate is the first day after the last instructional day in the current school year the data element is no longer associated to the Staff.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationClassroomPositionSet', @level2type=N'COLUMN', @level2name=N'ClassroomPositionEndDate'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3095. NumberOfStudentsInClassLastFridayFebruary indicates the number of students in membership in the class on the last Friday in February.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationExtension', @level2type=N'COLUMN', @level2name=N'NumberOfStudentsInClassLastFridayFebruary'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3094. NumberOfStudentsInClassLastFridayOctober indicates the number of students in membership in the class on the last Friday in October.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StaffSectionAssociationExtension', @level2type=N'COLUMN', @level2name=N'NumberOfStudentsInClassLastFridayOctober'
GO
