...
-- Table [tx].[AdultPreviousAttendanceDescriptor] --
CREATE TABLE [tx].[AdultPreviousAttendanceDescriptor] (
    [AdultPreviousAttendanceDescriptorId] [INT] NOT NULL,
    CONSTRAINT [AdultPreviousAttendanceDescriptor_PK] PRIMARY KEY CLUSTERED (
        [AdultPreviousAttendanceDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[AsOfStatusFirstFridayOctoberDescriptor] (
    ...
    CONSTRAINT [AsOfStatusFirstFridayOctoberDescriptor_PK] PRIMARY KEY CLUSTERED (
        [AsOfStatusFirstFridayOctoberDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[CameraRequestorDescriptor] (
    ...
    CONSTRAINT [CameraRequestorDescriptor_PK] PRIMARY KEY CLUSTERED (
        [CameraRequestorDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[CameraStatusDescriptor] (
    ...
    CONSTRAINT [CameraStatusDescriptor_PK] PRIMARY KEY CLUSTERED (
        [CameraStatusDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
-- Table [tx].[CourseTranscriptExt] --
CREATE TABLE [tx].[CourseTranscriptExt] (
    [CourseAttemptResultDescriptorId] [INT] NOT NULL,
    [CourseCourseCode] [NVARCHAR](60) NOT NULL,
    [CourseCourseEducationOrganizationId] [INT] NOT NULL,
    [CourseSequenceDescriptorId] [INT] NOT NULL,
    [EducationOrganizationId] [INT] NOT NULL,
    ...
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
    CONSTRAINT [CourseTranscriptExt_PK] PRIMARY KEY CLUSTERED (
        [CourseAttemptResultDescriptorId] ASC,
        [CourseCourseCode] ASC,
        [CourseCourseEducationOrganizationId] ASC,
        [CourseSequenceDescriptorId] ASC,
        [EducationOrganizationId] ASC,
        [LocalCourseCode] ASC,
        [SchoolId] ASC,
...
GO
ALTER TABLE [tx].[CourseTranscriptExt] ADD CONSTRAINT [CourseTranscriptExt_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [tx].[CourseTranscriptExt] ADD CONSTRAINT [CourseTranscriptExt_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tx].[CourseTranscriptExt] ADD CONSTRAINT [CourseTranscriptExt_DF_LastModifiedDate] DEFAULT (getdate()) FOR [LastModifiedDate]
GO
...
CREATE TABLE [tx].[DenialReasonDescriptor] (
    ...
    CONSTRAINT [DenialReasonDescriptor_PK] PRIMARY KEY CLUSTERED (
        [DenialReasonDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[FlexibleSpecialEducationTierOfIntensityAttendance] (
    ...
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
    CONSTRAINT [FlexibleSpecialEducationTierOfIntensityAttendance_PK] PRIMARY KEY CLUSTERED (
        [CalendarCode] ASC,
        [FlexAttendanceProgramDescriptorId] ASC,
        [GradeLevelDescriptorId] ASC,
        [ReportingPeriodDescriptorId] ASC,
        [SchoolId] ASC,
        [StudentUSI] ASC,
        [TierOfIntensityDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[FlexibleSpecialEducationTierOfIntensityAttendance] ADD CONSTRAINT [FlexibleSpecialEducationTierOfIntensityAttendance_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [tx].[FlexibleSpecialEducationTierOfIntensityAttendance] ADD CONSTRAINT [FlexibleSpecialEducationTierOfIntensityAttendance_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tx].[FlexibleSpecialEducationTierOfIntensityAttendance] ADD CONSTRAINT [FlexibleSpecialEducationTierOfIntensityAttendance_DF_LastModifiedDate] DEFAULT (getdate()) FOR [LastModifiedDate]
GO
...
CREATE TABLE [tx].[GradeLevelRangeDescriptor] (
    ...
    CONSTRAINT [GradeLevelRangeDescriptor_PK] PRIMARY KEY CLUSTERED (
        [GradeLevelRangeDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[GrievanceCorrectiveActionDescriptor] (
    ...
    CONSTRAINT [GrievanceCorrectiveActionDescriptor_PK] PRIMARY KEY CLUSTERED (
        [GrievanceCorrectiveActionDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[GrievanceExt] (
    ...
    [GrievanceCorrectiveActionDescriptorId] [INT] NULL,
    ...
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
    CONSTRAINT [GrievanceExt_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [GrievanceIdentifier] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[GrievanceExt] ADD CONSTRAINT [GrievanceExt_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [tx].[GrievanceExt] ADD CONSTRAINT [GrievanceExt_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tx].[GrievanceExt] ADD CONSTRAINT [GrievanceExt_DF_LastModifiedDate] DEFAULT (getdate()) FOR [LastModifiedDate]
GO
...
CREATE TABLE [tx].[GrievanceExtGrievanceLevelResolutionSet] (
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [GrievanceExtGrievanceLevelResolutionSet_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [GrievanceIdentifier] ASC,
        [GrievanceLevelDescriptorId] ASC,
        [GrievanceLevelResolvedDate] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[GrievanceExtGrievanceLevelResolutionSet] ADD CONSTRAINT [GrievanceExtGrievanceLevelResolutionSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO

-- Table [tx].[GrievanceLevelDescriptor] --
CREATE TABLE [tx].[GrievanceLevelDescriptor] (
    [GrievanceLevelDescriptorId] [INT] NOT NULL,
    CONSTRAINT [GrievanceLevelDescriptor_PK] PRIMARY KEY CLUSTERED (
        [GrievanceLevelDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[InstructionalSubjectDescriptor] (
    ...
    CONSTRAINT [InstructionalSubjectDescriptor_PK] PRIMARY KEY CLUSTERED (
        [InstructionalSubjectDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[OpenStaffPositionExt] (
    [EducationOrganizationId] [INT] NOT NULL,
    [PositionNumber] [NVARCHAR](20) NOT NULL,
    [StaffClassificationDescriptorId] [INT] NOT NULL,
    [Discriminator] [NVARCHAR](128) NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
    CONSTRAINT [OpenStaffPositionExt_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [PositionNumber] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[OpenStaffPositionExt] ADD CONSTRAINT [OpenStaffPositionExt_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [tx].[OpenStaffPositionExt] ADD CONSTRAINT [OpenStaffPositionExt_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tx].[OpenStaffPositionExt] ADD CONSTRAINT [OpenStaffPositionExt_DF_LastModifiedDate] DEFAULT (getdate()) FOR [LastModifiedDate]
GO
...
CREATE TABLE [tx].[OpenStaffPositionExtGradeLevelRange] (
    ...
    [GradeLevelRangeDescriptorId] [INT] NOT NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [OpenStaffPositionExtGradeLevelRange_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [PositionNumber] ASC,
        [GradeLevelRangeDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
GO
ALTER TABLE [tx].[OpenStaffPositionExtGradeLevelRange] ADD CONSTRAINT [OpenStaffPositionExtGradeLevelRange_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[OpenStaffPositionExtInstructionalSubject] (
    ...
    [InstructionalSubjectDescriptorId] [INT] NOT NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [OpenStaffPositionExtInstructionalSubject_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [PositionNumber] ASC,
        [InstructionalSubjectDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
GO
ALTER TABLE [tx].[OpenStaffPositionExtInstructionalSubject] ADD CONSTRAINT [OpenStaffPositionExtInstructionalSubject_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[OpenStaffPositionExtPositionVacancySet] (
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [OpenStaffPositionExtPositionVacancySet_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [PositionNumber] ASC,
        [DatePositionVacant] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[OpenStaffPositionExtPositionVacancySet] ADD CONSTRAINT [OpenStaffPositionExtPositionVacancySet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[OpenStaffPositionExtProgramAssignment] (
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [OpenStaffPositionExtProgramAssignment_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [PositionNumber] ASC,
...
GO
ALTER TABLE [tx].[OpenStaffPositionExtProgramAssignment] ADD CONSTRAINT [OpenStaffPositionExtProgramAssignment_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[PostingClosedReasonDescriptor] (
    ...
    CONSTRAINT [PostingClosedReasonDescriptor_PK] PRIMARY KEY CLUSTERED (
        [PostingClosedReasonDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[PriorYearSSAOrgAssociationExt] (
    ...
    [PriorYearSSATypeDescriptorId] [INT] NOT NULL,
    [Discriminator] [NVARCHAR](128) NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
    CONSTRAINT [PriorYearSSAOrgAssociationExt_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [FiscalAgentDistrictId] ASC,
        [PriorYearSSATypeDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[PriorYearSSAOrgAssociationExt] ADD CONSTRAINT [PriorYearSSAOrgAssociationExt_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [tx].[PriorYearSSAOrgAssociationExt] ADD CONSTRAINT [PriorYearSSAOrgAssociationExt_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tx].[PriorYearSSAOrgAssociationExt] ADD CONSTRAINT [PriorYearSSAOrgAssociationExt_DF_LastModifiedDate] DEFAULT (getdate()) FOR [LastModifiedDate]
GO

-- Table [tx].[PriorYearSSATypeDescriptor] --
CREATE TABLE [tx].[PriorYearSSATypeDescriptor] (
    [PriorYearSSATypeDescriptorId] [INT] NOT NULL,
    CONSTRAINT [PriorYearSSATypeDescriptor_PK] PRIMARY KEY CLUSTERED (
        [PriorYearSSATypeDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[ReasonNoSPEDServicesDescriptor] (
    ...
    CONSTRAINT [ReasonNoSPEDServicesDescriptor_PK] PRIMARY KEY CLUSTERED (
        [ReasonNoSPEDServicesDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[RequisitionExt] (
    ...
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
    CONSTRAINT [RequisitionExt_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [PositionNumber] ASC,
...
GO
ALTER TABLE [tx].[RequisitionExt] ADD CONSTRAINT [RequisitionExt_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [tx].[RequisitionExt] ADD CONSTRAINT [RequisitionExt_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tx].[RequisitionExt] ADD CONSTRAINT [RequisitionExt_DF_LastModifiedDate] DEFAULT (getdate()) FOR [LastModifiedDate]
GO

-- Table [tx].[ResolutionOfGrievanceDescriptor] --
CREATE TABLE [tx].[ResolutionOfGrievanceDescriptor] (
    [ResolutionOfGrievanceDescriptorId] [INT] NOT NULL,
    CONSTRAINT [ResolutionOfGrievanceDescriptor_PK] PRIMARY KEY CLUSTERED (
        [ResolutionOfGrievanceDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[SpecialEducationTierOfIntensityAttendance] (
    ...
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
    CONSTRAINT [SpecialEducationTierOfIntensityAttendance_PK] PRIMARY KEY CLUSTERED (
        [CalendarCode] ASC,
        [GradeLevelDescriptorId] ASC,
        [RegionalDaySchoolProgramForDeafDescriptorId] ASC,
        [ReportingPeriodDescriptorId] ASC,
...
GO
ALTER TABLE [tx].[SpecialEducationTierOfIntensityAttendance] ADD CONSTRAINT [SpecialEducationTierOfIntensityAttendance_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [tx].[SpecialEducationTierOfIntensityAttendance] ADD CONSTRAINT [SpecialEducationTierOfIntensityAttendance_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tx].[SpecialEducationTierOfIntensityAttendance] ADD CONSTRAINT [SpecialEducationTierOfIntensityAttendance_DF_LastModifiedDate] DEFAULT (getdate()) FOR [LastModifiedDate]
GO
...
CREATE TABLE [tx].[SPEDServiceGroupDescriptor] (
    ...
    CONSTRAINT [SPEDServiceGroupDescriptor_PK] PRIMARY KEY CLUSTERED (
        [SPEDServiceGroupDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[SPEDVideoCameraRequestExt] (
    ...
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
    CONSTRAINT [SPEDVideoCameraRequestExt_PK] PRIMARY KEY CLUSTERED (
        [RequestId] ASC,
        [SchoolId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[SPEDVideoCameraRequestExt] ADD CONSTRAINT [SPEDVideoCameraRequestExt_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
ALTER TABLE [tx].[SPEDVideoCameraRequestExt] ADD CONSTRAINT [SPEDVideoCameraRequestExt_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tx].[SPEDVideoCameraRequestExt] ADD CONSTRAINT [SPEDVideoCameraRequestExt_DF_LastModifiedDate] DEFAULT (getdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tx].[StaffEducationOrganizationEmploymentAssociationDaysEmployedSet] ADD CONSTRAINT [StaffEducationOrganizationEmploymentAssociationDaysEmployedSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
-- Table [tx].[StudentAcademicRecordAssociateDegreeIndicatorSet] --
CREATE TABLE [tx].[StudentAcademicRecordAssociateDegreeIndicatorSet] (
    [EducationOrganizationId] [INT] NOT NULL,
    [SchoolYear] [SMALLINT] NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [TermDescriptorId] [INT] NOT NULL,
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentAcademicRecordAssociateDegreeIndicatorSet_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [SchoolYear] ASC,
        [StudentUSI] ASC,
        [TermDescriptorId] ASC,
...
GO
ALTER TABLE [tx].[StudentAcademicRecordAssociateDegreeIndicatorSet] ADD CONSTRAINT [StudentAcademicRecordAssociateDegreeIndicatorSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
-- Table [tx].[StudentAcademicRecordEndorsementCompletedSet] --
CREATE TABLE [tx].[StudentAcademicRecordEndorsementCompletedSet] (
    [EducationOrganizationId] [INT] NOT NULL,
    [SchoolYear] [SMALLINT] NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [TermDescriptorId] [INT] NOT NULL,
    ...
    [EndorsementCompletedDescriptorId] [INT] NOT NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentAcademicRecordEndorsementCompletedSet_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [SchoolYear] ASC,
        [StudentUSI] ASC,
        [TermDescriptorId] ASC,
...
GO
ALTER TABLE [tx].[StudentAcademicRecordEndorsementCompletedSet] ADD CONSTRAINT [StudentAcademicRecordEndorsementCompletedSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO

-- Table [tx].[StudentAcademicRecordGraduationProgramParticipationSet] --
CREATE TABLE [tx].[StudentAcademicRecordGraduationProgramParticipationSet] (
    [EducationOrganizationId] [INT] NOT NULL,
    [SchoolYear] [SMALLINT] NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [TermDescriptorId] [INT] NOT NULL,
    [FHSPDistingLevelParticipant] [BIT] NOT NULL,
    [FHSPParticipant] [BIT] NOT NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentAcademicRecordGraduationProgramParticipationSet_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [SchoolYear] ASC,
        [StudentUSI] ASC,
        [TermDescriptorId] ASC
...
GO
ALTER TABLE [tx].[StudentAcademicRecordGraduationProgramParticipationSet] ADD CONSTRAINT [StudentAcademicRecordGraduationProgramParticipationSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO

-- Table [tx].[StudentAcademicRecordGraduationProgramParticipationSetEndorsementPursuing] --
CREATE TABLE [tx].[StudentAcademicRecordGraduationProgramParticipationSetEndorsementPursuing] (
    [EducationOrganizationId] [INT] NOT NULL,
    [SchoolYear] [SMALLINT] NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [TermDescriptorId] [INT] NOT NULL,
    [EndorsementPursuingDescriptorId] [INT] NOT NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentAcademicRecordGraduationProgramParticipationSetEndorsementPursuing_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [SchoolYear] ASC,
        [StudentUSI] ASC,
        [TermDescriptorId] ASC,
...
GO
ALTER TABLE [tx].[StudentAcademicRecordGraduationProgramParticipationSetEndorsementPursuing] ADD CONSTRAINT [StudentAcademicRecordGraduationProgramParticipationSetEndorsementPursuing_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO

-- Table [tx].[StudentAcademicRecordIndividualGraduationCommitteeReviewSet] --
CREATE TABLE [tx].[StudentAcademicRecordIndividualGraduationCommitteeReviewSet] (
    [EducationOrganizationId] [INT] NOT NULL,
    [SchoolYear] [SMALLINT] NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [TermDescriptorId] [INT] NOT NULL,
...
GO
ALTER TABLE [tx].[StudentAcademicRecordIndividualGraduationCommitteeReviewSet] ADD CONSTRAINT [StudentAcademicRecordIndividualGraduationCommitteeReviewSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tx].[StudentCTEProgramAssociationCTEProgSVCSet] ADD CONSTRAINT [StudentCTEProgramAssociationCTEProgSVCSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO

-- Table [tx].[StudentDisciplineIncidentBehaviorAssociationExtension] --
CREATE TABLE [tx].[StudentDisciplineIncidentBehaviorAssociationExtension] (
...
GO
ALTER TABLE [tx].[StudentDisciplineIncidentBehaviorAssociationExtension] ADD CONSTRAINT [StudentDisciplineIncidentBehaviorAssociationExtension_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[StudentEducationOrganizationAssociationAcceleratedInstructionSet] (
    ...
    [RatioWaiverListProductUsed] [BIT] NULL,
    [CreateDate] [DATETIME2] NOT NULL,
...
-- Table [tx].[StudentEducationOrganizationAssociationAdultPreviousAttendanceSet] --
CREATE TABLE [tx].[StudentEducationOrganizationAssociationAdultPreviousAttendanceSet] (
    [EducationOrganizationId] [INT] NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [AdultPreviousAttendanceDescriptorId] [INT] NOT NULL,
    [BeginDate] [DATE] NOT NULL,
    [EndDate] [DATE] NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentEducationOrganizationAssociationAdultPreviousAttendanceSet_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [StudentUSI] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[StudentEducationOrganizationAssociationAdultPreviousAttendanceSet] ADD CONSTRAINT [StudentEducationOrganizationAssociationAdultPreviousAttendanceSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tx].[StudentEducationOrganizationAssociationFullTimeHybridVirtualProgramParticipationSet] ADD CONSTRAINT [StudentEducationOrganizationAssociationFullTimeHybridVirtualProgramParticipationSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tx].[StudentLanguageInstructionProgramAssociationLangInstruProgramSvcSet] ADD CONSTRAINT [StudentLanguageInstructionProgramAssociationLangInstruProgramSvcSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
-- Table [tx].[StudentSpecialEducationProgramAssociationEducationalEnvironmentSet] --
CREATE TABLE [tx].[StudentSpecialEducationProgramAssociationEducationalEnvironmentSet] (
    [BeginDate] [DATE] NOT NULL,
    [EducationOrganizationId] [INT] NOT NULL,
    [ProgramEducationOrganizationId] [INT] NOT NULL,
    [ProgramName] [NVARCHAR](60) NOT NULL,
    [ProgramTypeDescriptorId] [INT] NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [EducationalEnvironmentBeginDate] [DATE] NOT NULL,
    [EducationalEnvironmentDescriptorId] [INT] NOT NULL,
    [EducationalEnvironmentEndDate] [DATE] NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentSpecialEducationProgramAssociationEducationalEnvironmentSet_PK] PRIMARY KEY CLUSTERED (
        [BeginDate] ASC,
        [EducationOrganizationId] ASC,
        [ProgramEducationOrganizationId] ASC,
        [ProgramName] ASC,
        [ProgramTypeDescriptorId] ASC,
        [StudentUSI] ASC,
        [EducationalEnvironmentBeginDate] ASC,
        [EducationalEnvironmentDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[StudentSpecialEducationProgramAssociationEducationalEnvironmentSet] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationEducationalEnvironmentSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
-- Table [tx].[StudentSpecialEducationProgramAssociationNumberOfMinutesInSPEDSet] --
CREATE TABLE [tx].[StudentSpecialEducationProgramAssociationNumberOfMinutesInSPEDSet] (
    [BeginDate] [DATE] NOT NULL,
    [EducationOrganizationId] [INT] NOT NULL,
    [ProgramEducationOrganizationId] [INT] NOT NULL,
    [ProgramName] [NVARCHAR](60) NOT NULL,
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentSpecialEducationProgramAssociationNumberOfMinutesInSPEDSet_PK] PRIMARY KEY CLUSTERED (
        [BeginDate] ASC,
        [EducationOrganizationId] ASC,
        [ProgramEducationOrganizationId] ASC,
        [ProgramName] ASC,
        [ProgramTypeDescriptorId] ASC,
        [StudentUSI] ASC,
        [NumberOfMinutesInSPED] ASC,
        [NumberOfMinutesInSPEDBeginDate] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[StudentSpecialEducationProgramAssociationNumberOfMinutesInSPEDSet] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationNumberOfMinutesInSPEDSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tx].[StudentSpecialEducationProgramAssociationSPEDProgramSvcSet] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationSPEDProgramSvcSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[StudentSpecialEducationProgramAssociationSPEDServiceGroupSet] (
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentSpecialEducationProgramAssociationSPEDServiceGroupSet_PK] PRIMARY KEY CLUSTERED (
        [BeginDate] ASC,
        [EducationOrganizationId] ASC,
        [ProgramEducationOrganizationId] ASC,
        [ProgramName] ASC,
        [ProgramTypeDescriptorId] ASC,
        [StudentUSI] ASC,
        [SPEDServiceGroupBeginDate] ASC,
        [SPEDServiceGroupDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[StudentSpecialEducationProgramAssociationSPEDServiceGroupSet] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationSPEDServiceGroupSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tx].[StudentSpecialEducationProgramAssociationStudentEarlyChildhoodOutcomesEntrySet] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationStudentEarlyChildhoodOutcomesEntrySet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tx].[StudentSpecialEducationProgramAssociationStudentEarlyChildhoodOutcomesExitSet] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationStudentEarlyChildhoodOutcomesExitSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[StudentSpecialEducationProgramAssociationStudentSecondaryTransitionSet] (
    ...
    [SecondaryTransitionIEPReviewDate] [DATE] NOT NULL,
...
GO
ALTER TABLE [tx].[StudentSpecialEducationProgramAssociationStudentSecondaryTransitionSet] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationStudentSecondaryTransitionSet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[StudentSpecialEducationProgramAssociationTierOfIntensitySet] (
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [StudentSpecialEducationProgramAssociationTierOfIntensitySet_PK] PRIMARY KEY CLUSTERED (
        [BeginDate] ASC,
        [EducationOrganizationId] ASC,
        [ProgramEducationOrganizationId] ASC,
        [ProgramName] ASC,
        [ProgramTypeDescriptorId] ASC,
        [StudentUSI] ASC,
        [TierOfIntensityBeginDate] ASC,
        [TierOfIntensityDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tx].[StudentSpecialEducationProgramAssociationTierOfIntensitySet] ADD CONSTRAINT [StudentSpecialEducationProgramAssociationTierOfIntensitySet_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tx].[TierOfIntensityDescriptor] (
    [TierOfIntensityDescriptorId] [INT] NOT NULL,
    CONSTRAINT [TierOfIntensityDescriptor_PK] PRIMARY KEY CLUSTERED (
        [TierOfIntensityDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tx].[VacancyReasonDescriptor] (
    [VacancyReasonDescriptorId] [INT] NOT NULL,
    CONSTRAINT [VacancyReasonDescriptor_PK] PRIMARY KEY CLUSTERED (
        [VacancyReasonDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
