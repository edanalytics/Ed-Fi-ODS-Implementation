...
CREATE TABLE tx.AdultPreviousAttendanceDescriptor (
    ...
    CONSTRAINT AdultPreviousAttendanceDescriptor_PK PRIMARY KEY (AdultPreviousAttendanceDescriptorId)
);
...
CREATE TABLE tx.CourseTranscriptExt (
    ...
    CourseCourseCode VARCHAR(60) NOT NULL,
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT CourseTranscriptExt_PK PRIMARY KEY (CourseAttemptResultDescriptorId, CourseCourseCode, CourseCourseEducationOrganizationId, CourseSequenceDescriptorId, EducationOrganizationId, LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName, StudentUSI, TermDescriptorId)
);
ALTER TABLE tx.CourseTranscriptExt ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.CourseTranscriptExt ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.CourseTranscriptExt ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.FlexibleSpecialEducationTierOfIntensityAttendance ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.FlexibleSpecialEducationTierOfIntensityAttendance ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.FlexibleSpecialEducationTierOfIntensityAttendance ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.GrievanceExt ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.GrievanceExt ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.GrievanceExt ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.GrievanceExtGrievanceLevelResolutionSet (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT GrievanceExtGrievanceLevelResolutionSet_PK PRIMARY KEY (EducationOrganizationId, GrievanceIdentifier, GrievanceLevelDescriptorId, GrievanceLevelResolvedDate)
);
ALTER TABLE tx.GrievanceExtGrievanceLevelResolutionSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.OpenStaffPositionExt ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.OpenStaffPositionExt ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.OpenStaffPositionExt ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.OpenStaffPositionExtGradeLevelRange ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.OpenStaffPositionExtInstructionalSubject ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.OpenStaffPositionExtPositionVacancySet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.OpenStaffPositionExtProgramAssignment ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.PriorYearActualExt ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.PriorYearActualExt ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.PriorYearActualExt ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.PriorYearSSAOrgAssociationExt (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT PriorYearSSAOrgAssociationExt_PK PRIMARY KEY (EducationOrganizationId, FiscalAgentDistrictId, PriorYearSSATypeDescriptorId)
);
ALTER TABLE tx.PriorYearSSAOrgAssociationExt ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.PriorYearSSAOrgAssociationExt ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.PriorYearSSAOrgAssociationExt ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;

-- Table tx.PriorYearSSATypeDescriptor --
CREATE TABLE tx.PriorYearSSATypeDescriptor (
    PriorYearSSATypeDescriptorId INT NOT NULL,
    CONSTRAINT PriorYearSSATypeDescriptor_PK PRIMARY KEY (PriorYearSSATypeDescriptorId)
);
...
ALTER TABLE tx.RequisitionExt ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.RequisitionExt ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.RequisitionExt ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.SpecialEducationTierOfIntensityAttendance ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.SpecialEducationTierOfIntensityAttendance ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.SpecialEducationTierOfIntensityAttendance ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.SPEDVideoCameraRequestExt ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE tx.SPEDVideoCameraRequestExt ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tx.SPEDVideoCameraRequestExt ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StaffEducationOrganizationEmploymentAssociationDaysEmployedSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.StudentAcademicRecordAssociateDegreeIndicatorSet (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentAcademicRecordAssociateDegreeIndicatorSet_PK PRIMARY KEY (EducationOrganizationId, SchoolYear, StudentUSI, TermDescriptorId, AssociateDegreeIndicatorDescriptorId, EarnedDate)
);
ALTER TABLE tx.StudentAcademicRecordAssociateDegreeIndicatorSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.StudentAcademicRecordEndorsementCompletedSet (
    ...
    EndorsementCompletedDescriptorId INT NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentAcademicRecordEndorsementCompletedSet_PK PRIMARY KEY (EducationOrganizationId, SchoolYear, StudentUSI, TermDescriptorId, CompletedDate, EndorsementCompletedDescriptorId)
);
ALTER TABLE tx.StudentAcademicRecordEndorsementCompletedSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.StudentAcademicRecordGraduationProgramParticipationSet (
    ...
    StudentUSI INT NOT NULL,
    TermDescriptorId INT NOT NULL,
    FHSPDistingLevelParticipant BOOLEAN NOT NULL,
    FHSPParticipant BOOLEAN NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentAcademicRecordGraduationProgramParticipationSet_PK PRIMARY KEY (EducationOrganizationId, SchoolYear, StudentUSI, TermDescriptorId)
);
ALTER TABLE tx.StudentAcademicRecordGraduationProgramParticipationSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;

-- Table tx.StudentAcademicRecordGraduationProgramParticipationSetEn_a4188b --
CREATE TABLE tx.StudentAcademicRecordGraduationProgramParticipationSetEn_a4188b (
    EducationOrganizationId INT NOT NULL,
    SchoolYear SMALLINT NOT NULL,
    StudentUSI INT NOT NULL,
    TermDescriptorId INT NOT NULL,
    EndorsementPursuingDescriptorId INT NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentAcademicRecordGraduationProgramParticipatio_a4188b_PK PRIMARY KEY (EducationOrganizationId, SchoolYear, StudentUSI, TermDescriptorId, EndorsementPursuingDescriptorId)
);
ALTER TABLE tx.StudentAcademicRecordGraduationProgramParticipationSetEn_a4188b ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentAcademicRecordIndividualGraduationCommitteeReviewSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentCTEProgramAssociationCTEProgSVCSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentDisciplineIncidentBehaviorAssociationExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentEducationOrganizationAssociationAcceleratedInstru_a3bffb ALTER COLUMN CreateDate SET DEFAULT current_timestamp;

-- Table tx.StudentEducationOrganizationAssociationAdultPreviousAtte_49964b --
CREATE TABLE tx.StudentEducationOrganizationAssociationAdultPreviousAtte_49964b (
    EducationOrganizationId INT NOT NULL,
    StudentUSI INT NOT NULL,
    AdultPreviousAttendanceDescriptorId INT NOT NULL,
    BeginDate DATE NOT NULL,
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentEducationOrganizationAssociationAdultPrevio_49964b_PK PRIMARY KEY (EducationOrganizationId, StudentUSI)
);
ALTER TABLE tx.StudentEducationOrganizationAssociationAdultPreviousAtte_49964b ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentEducationOrganizationAssociationExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentEducationOrganizationAssociationFullTimeHybridVir_af4759 ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentLanguageInstructionProgramAssociationLangInstruPr_cc68d7 ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
-- Table tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119 --
CREATE TABLE tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119 (
    BeginDate DATE NOT NULL,
    EducationOrganizationId INT NOT NULL,
    ProgramEducationOrganizationId INT NOT NULL,
    ProgramName VARCHAR(60) NOT NULL,
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentSpecialEducationProgramAssociationEducation_71c119_PK PRIMARY KEY (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI, EducationalEnvironmentBeginDate, EducationalEnvironmentDescriptorId)
);
ALTER TABLE tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119 ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentSpecialEducationProgramAssociationNumberOfMinutes_6c1b0f ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentSpecialEducationProgramAssociationSPEDProgramSvcSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentSpecialEducationProgramAssociationSPEDServiceGroupSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentSpecialEducationProgramAssociationStudentEarlyChi_8841ca ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentSpecialEducationProgramAssociationStudentEarlyChi_c55f34 ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentSpecialEducationProgramAssociationStudentSecondar_756764 ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
ALTER TABLE tx.StudentSpecialEducationProgramAssociationTierOfIntensitySet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
