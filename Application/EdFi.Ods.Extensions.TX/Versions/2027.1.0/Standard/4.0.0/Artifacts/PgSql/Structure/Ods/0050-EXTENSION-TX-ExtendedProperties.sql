...
COMMENT ON COLUMN tx.GrievanceExt.GrievanceCorrectiveActionDescriptorId IS 'E3139, C364. GrievanceCorrectiveAction indicates corrective action taken by the district based on the grievance filed.';
...
-- Extended Properties [tx].[StudentSpecialEducationProgramAssociationEducationalEnvi_71c119] --
COMMENT ON TABLE tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119 IS 'The EducationalEnvironmentSet common type captures the educational environment setting in which a student receives special education and related services and the EducationalEnvironmentBeginDate and EducationalEnvironmentEndDate.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.BeginDate IS 'The earliest date the student is involved with the program. Typically, this is the date the student becomes eligible for the program.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.ProgramEducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.ProgramName IS 'The formal name of the program of instruction, training, services, or benefits available through federal, state, or local agencies.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.ProgramTypeDescriptorId IS 'The type of program.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.EducationalEnvironmentBeginDate IS 'E3175. EducationalEnvironmentBeginDate is the first instructional day a student is assigned to the EducationalEnvironment descriptor.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.EducationalEnvironmentDescriptorId IS 'E3155, C372. EducationalEnvironment indicates the setting in which a student receives special education and related services.';
COMMENT ON COLUMN tx.StudentSpecialEducationProgramAssociationEducationalEnvi_71c119.EducationalEnvironmentEndDate IS 'E3176. EducationalEnvironmentEndDate is the first day after the last instructional day a student was assigned to the EducationalEnvironment descriptor.';
