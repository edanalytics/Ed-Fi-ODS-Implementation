...
BEGIN
ALTER TABLE [tx].[ActualExt] ADD [ChangeVersion] [BIGINT] CONSTRAINT ActualExt_DF_ChangeVersion DEFAULT (0) NOT NULL;
ALTER TABLE [tx].[ActualExt] DROP CONSTRAINT ActualExt_DF_ChangeVersion;
ALTER TABLE [tx].[ActualExt] ADD CONSTRAINT ActualExt_DF_ChangeVersion DEFAULT (NEXT VALUE FOR [changes].[ChangeVersionSequence]) For [ChangeVersion];
END
