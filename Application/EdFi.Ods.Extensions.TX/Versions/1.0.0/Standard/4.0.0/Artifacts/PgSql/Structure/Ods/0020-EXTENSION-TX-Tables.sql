...
CREATE TABLE tx.SectionSet (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT SectionSet_PK PRIMARY KEY (LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName, BeginDate)
);
...
CREATE TABLE tx.StaffEducationOrganizationAssignmentAssociationStaffServiceSet (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StaffEducationOrganizationAssignmentAssociationSta_0bf4c3_PK PRIMARY KEY (BeginDate, EducationOrganizationId, StaffClassificationDescriptorId, StaffUSI, StaffServiceBeginDate, StaffServiceDescriptorId)
);
...
-- Table tx.StaffSectionAssociationClassroomPositionSet --
CREATE TABLE tx.StaffSectionAssociationClassroomPositionSet (
    LocalCourseCode VARCHAR(60) NOT NULL,
    SchoolId INT NOT NULL,
    SchoolYear SMALLINT NOT NULL,
    SectionIdentifier VARCHAR(255) NOT NULL,
    SessionName VARCHAR(60) NOT NULL,
    StaffUSI INT NOT NULL,
    ClassroomPositionBeginDate DATE NOT NULL,
    ClassroomPositionDescriptorId INT NOT NULL,
    ClassroomPositionEndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StaffSectionAssociationClassroomPositionSet_PK PRIMARY KEY (LocalCourseCode, SchoolId, SchoolYear, SectionIdentifier, SessionName, StaffUSI, ClassroomPositionBeginDate, ClassroomPositionDescriptorId)
);
ALTER TABLE tx.StaffSectionAssociationClassroomPositionSet ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE tx.StaffSectionAssociationExtension (
    ...
    NumberOfStudentsInClassLastFridayFebruary INT NULL,
    NumberOfStudentsInClassLastFridayOctober INT NULL,
    SharedServiceArrangementStaffDescriptorId INT NULL,
    CreateDate TIMESTAMP NOT NULL,
