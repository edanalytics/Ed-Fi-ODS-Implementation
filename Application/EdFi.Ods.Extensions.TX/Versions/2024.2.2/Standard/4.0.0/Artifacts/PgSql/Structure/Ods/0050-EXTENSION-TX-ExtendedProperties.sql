...
COMMENT ON COLUMN tx.CourseTranscriptExtension.LocalCourseCode IS 'The local code assigned by the School that identifies the course offering provided for the instruction of students.';
COMMENT ON COLUMN tx.CourseTranscriptExtension.SchoolId IS 'The identifier assigned to a school.';
COMMENT ON COLUMN tx.CourseTranscriptExtension.SectionIdentifier IS 'The local identifier assigned to a section.';
COMMENT ON COLUMN tx.CourseTranscriptExtension.SessionName IS 'The identifier for the calendar for the academic session.';
...
COMMENT ON TABLE tx.StaffSectionAssociationClassroomPositionSet IS 'Common Type ClassroomPositionSet is used to add effective date to the element ClassroomPosition.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.LocalCourseCode IS 'The local code assigned by the School that identifies the course offering provided for the instruction of students.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.SchoolId IS 'The identifier assigned to a school.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.SchoolYear IS 'The identifier for the school year.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.SectionIdentifier IS 'The local identifier assigned to a section.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.SessionName IS 'The identifier for the calendar for the academic session.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.StaffUSI IS 'A unique alphanumeric code assigned to a staff.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.ClassroomPositionBeginDate IS 'E3092. ClassroomPositionBeginDate is the first instructional day in the current school year the data element is associated to the Staff.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.ClassroomPositionDescriptorId IS 'E1454, C309. ClassroomPosition indicates the type of position the staff member holds in the specific class/section; for example: Teacher of Record, Assistant Teacher, Support Teacher, Substitute Teacher.';
COMMENT ON COLUMN tx.StaffSectionAssociationClassroomPositionSet.ClassroomPositionEndDate IS 'E3093. ClassroomPositionEndDate is the first day after the last instructional day in the current school year the data element is no longer associated to the Staff.';
...
COMMENT ON COLUMN tx.StaffSectionAssociationExtension.NumberOfStudentsInClassLastFridayFebruary IS 'E3095. NumberOfStudentsInClassLastFridayFebruary indicates the number of students in membership in the class on the last Friday in February.';
COMMENT ON COLUMN tx.StaffSectionAssociationExtension.NumberOfStudentsInClassLastFridayOctober IS 'E3094. NumberOfStudentsInClassLastFridayOctober indicates the number of students in membership in the class on the last Friday in October.';
