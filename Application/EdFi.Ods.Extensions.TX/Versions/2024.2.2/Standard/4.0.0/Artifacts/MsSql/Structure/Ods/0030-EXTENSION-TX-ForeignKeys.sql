...
ALTER TABLE [tx].[StaffSectionAssociationClassroomPositionSet] WITH CHECK ADD CONSTRAINT [FK_StaffSectionAssociationClassroomPositionSet_ClassroomPositionDescriptor] FOREIGN KEY ([ClassroomPositionDescriptorId])
REFERENCES [edfi].[ClassroomPositionDescriptor] ([ClassroomPositionDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StaffSectionAssociationClassroomPositionSet_ClassroomPositionDescriptor]
ON [tx].[StaffSectionAssociationClassroomPositionSet] ([ClassroomPositionDescriptorId] ASC)
GO

ALTER TABLE [tx].[StaffSectionAssociationClassroomPositionSet] WITH CHECK ADD CONSTRAINT [FK_StaffSectionAssociationClassroomPositionSet_StaffSectionAssociation] FOREIGN KEY ([LocalCourseCode], [SchoolId], [SchoolYear], [SectionIdentifier], [SessionName], [StaffUSI])
