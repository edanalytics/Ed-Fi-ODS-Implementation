...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_ActualExt_EducationOrganizationId' AND object_id = OBJECT_ID('tx.ActualExt')) 
BEGIN
    CREATE INDEX IX_ActualExt_EducationOrganizationId ON tx.ActualExt(EducationOrganizationId) INCLUDE (Id)
END;
