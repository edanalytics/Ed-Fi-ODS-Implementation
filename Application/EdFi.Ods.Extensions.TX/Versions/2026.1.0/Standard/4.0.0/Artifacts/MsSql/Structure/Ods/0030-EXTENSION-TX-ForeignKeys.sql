...
ALTER TABLE [tx].[CourseTranscriptExtension] WITH CHECK ADD CONSTRAINT [FK_CourseTranscriptExtension_DropoutRecoveryCourseCompletionDescriptor] FOREIGN KEY ([DropoutRecoveryCourseCompletionDescriptorId])
REFERENCES [tx].[DropoutRecoveryCourseCompletionDescriptor] ([DropoutRecoveryCourseCompletionDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_CourseTranscriptExtension_DropoutRecoveryCourseCompletionDescriptor]
...
ALTER TABLE [tx].[PreschoolOutcomesReportingDescriptor] WITH CHECK ADD CONSTRAINT [FK_PreschoolOutcomesReportingDescriptor_Descriptor] FOREIGN KEY ([PreschoolOutcomesReportingDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [tx].[PriorYearLeaver] WITH CHECK ADD CONSTRAINT [FK_PriorYearLeaver_LangInstruProgramSvcDescriptor] FOREIGN KEY ([LangInstruProgramSvcDescriptorId])
REFERENCES [tx].[LangInstruProgramSvcDescriptor] ([LangInstruProgramSvcDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_PriorYearLeaver_LangInstruProgramSvcDescriptor]
...
ALTER TABLE [tx].[SchoolExtension] WITH CHECK ADD CONSTRAINT [FK_SchoolExtension_PreschoolOutcomesReportingDescriptor] FOREIGN KEY ([PreschoolOutcomesReportingDescriptorId])
REFERENCES [tx].[PreschoolOutcomesReportingDescriptor] ([PreschoolOutcomesReportingDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_SchoolExtension_PreschoolOutcomesReportingDescriptor]
