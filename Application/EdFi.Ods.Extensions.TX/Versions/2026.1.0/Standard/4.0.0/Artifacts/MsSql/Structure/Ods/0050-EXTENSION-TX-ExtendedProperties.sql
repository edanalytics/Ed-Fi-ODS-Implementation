...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3097, C355. DropoutRecoveryCourseCompletion indicates if the course completed by a student in a dropout recovery education program under TEC §29.081 was completed in person or remotely.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'DropoutRecoveryCourseCompletionDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3120. OnRampsDualEnrollmentIndicator indicates that the student has completed an OnRamps dual enrollment course.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'OnRampsDualEnrollmentIndicator'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3091. SummerSchoolIndicator indicates the course completed by a student was completed during the summer (between school years).', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'CourseTranscriptExtension', @level2type=N'COLUMN', @level2name=N'SummerSchoolIndicator'
GO
...
-- Extended Properties [tx].[PreschoolOutcomesReportingDescriptor] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3098. PreschoolOutcomesReporting indicates if a school does not have any eligible students in an early childhood special education (ECSE) program that meet the preschool outcomes entry or exit criteria.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PreschoolOutcomesReportingDescriptor'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PreschoolOutcomesReportingDescriptor', @level2type=N'COLUMN', @level2name=N'PreschoolOutcomesReportingDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E0790, C061. EmergentBilingualIndicator is an indication that the student has been identified as an emergent bilingual (EB) student by the Language Proficiency Assessment Committee (LPAC), or English proficient according to the criteria established in 19 TAC §89.1226.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaver', @level2type=N'COLUMN', @level2name=N'EmergentBilingualIndicatorDescriptorId'
GO
...
(ii) children and youths who have a primary nighttime residence that is a public or private place not designed for or ordinarily used as a regular sleeping accommodation for human beings [within the meaning of section 11302(a)(2)(C)];
(iii) children and youths who are living in cars, parks, public spaces, abandoned buildings, substandard housing, bus or train stations, or similar settings; and
(iv) migratory children (as such term is defined in section 6399 of title 20) who qualify as homeless for the purposes of this subtitle because the children are living in circumstances described in clauses (i) through (iii).', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaver', @level2type=N'COLUMN', @level2name=N'HomelessStatusDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3034, C335. The LangInstruProgramSvc defines the services provided by an education organization to populations of students associated with a language instruction program.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'PriorYearLeaver', @level2type=N'COLUMN', @level2name=N'LangInstruProgramSvcDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3098, C356. PreschoolOutcomesReporting indicates if a school does not have any eligible students in an early childhood special education (ECSE) program that meet the preschool outcomes entry or exit criteria.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'SchoolExtension', @level2type=N'COLUMN', @level2name=N'PreschoolOutcomesReportingDescriptorId'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3021, C332. EndorsementCompleted indicates the student has successfully completed a Foundation High School Program to earn a STEM, Business and Industry, Public Services, Arts and Humanities, or Multi-Disciplinary Studies endorsement.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StudentAcademicRecordEndorsementCompleted'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3099. SecondaryTransitionIEPReviewDate is the date the Local Education Agency (LEA) reviewed the student''s individualized education program (IEP) folder for documentation of the SPPI-13 indicator requirements.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationExtension', @level2type=N'COLUMN', @level2name=N'SecondaryTransitionIEPReviewDate'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'E3065. StudentResFacAssocSetEndDate indicates the first month, day, and year the student was no longer in attendance at a residential facility.', @level0type=N'SCHEMA', @level0name=N'tx', @level1type=N'TABLE', @level1name=N'StudentSpecialEducationProgramAssociationStudentResidentialFacilityAssociationStudentResFacAssocSet', @level2type=N'COLUMN', @level2name=N'StudentResFacAssocSetEndDate'
GO
...
transition services based upon an age-appropriate transition assessment, including courses of study, that will reasonably enable the student to meet those postsecondary goals, and
