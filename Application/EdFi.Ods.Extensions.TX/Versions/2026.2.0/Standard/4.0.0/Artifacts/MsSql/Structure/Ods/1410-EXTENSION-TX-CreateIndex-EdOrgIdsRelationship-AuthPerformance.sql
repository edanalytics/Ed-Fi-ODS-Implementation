...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_CourseTranscriptExt_EducationOrganizationId' AND object_id = OBJECT_ID('tx.CourseTranscriptExt')) 
BEGIN
    CREATE INDEX IX_CourseTranscriptExt_EducationOrganizationId ON [tx].[CourseTranscriptExt](EducationOrganizationId) INCLUDE (Id)
END;

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_CourseTranscriptExt_SchoolId' AND object_id = OBJECT_ID('tx.CourseTranscriptExt')) 
BEGIN
    CREATE INDEX IX_CourseTranscriptExt_SchoolId ON [tx].[CourseTranscriptExt](SchoolId) INCLUDE (Id)
END;
...
BEGIN
    CREATE INDEX IX_PriorYearSSAOrgAssociationExt_EducationOrganizationId ON [tx].[PriorYearSSAOrgAssociationExt](EducationOrganizationId) INCLUDE (Id)
END;
