...
CREATE INDEX IF NOT EXISTS IX_CourseTranscriptExt_EducationOrganizationId ON tx.CourseTranscriptExt(EducationOrganizationId) INCLUDE (Id);

CREATE INDEX IF NOT EXISTS IX_CourseTranscriptExt_SchoolId ON tx.CourseTranscriptExt(SchoolId) INCLUDE (Id);
