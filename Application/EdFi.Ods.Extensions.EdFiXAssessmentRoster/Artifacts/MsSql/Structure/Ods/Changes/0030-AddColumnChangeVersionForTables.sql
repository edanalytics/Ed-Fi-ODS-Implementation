...
ALTER TABLE [edfixassessmentroster].[AssessmentAdministrationParticipation] ADD [ChangeVersion] [BIGINT] DEFAULT (NEXT VALUE FOR [changes].[ChangeVersionSequence]) NOT NULL;
