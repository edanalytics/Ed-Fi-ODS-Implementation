...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The anticipated administration of an assessment under the purview of an EducationOrganization.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipation'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The title or name of the assessment in the context of it''s administration.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipation', @level2type=N'COLUMN', @level2name=N'AdministrationIdentifier'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique number or alphanumeric code assigned to an assessment.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipation', @level2type=N'COLUMN', @level2name=N'AssessmentIdentifier'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipation', @level2type=N'COLUMN', @level2name=N'AssigningEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Namespace for the assessment.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipation', @level2type=N'COLUMN', @level2name=N'Namespace'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipation', @level2type=N'COLUMN', @level2name=N'ParticipatingEducationOrganizationId'
GO

-- Extended Properties [edfixassessmentroster].[AssessmentAdministrationParticipationAdministrationContact] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Pre-identified contacts for education organizations administering the assessment', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The title or name of the assessment in the context of it''s administration.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'AdministrationIdentifier'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique number or alphanumeric code assigned to an assessment.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'AssessmentIdentifier'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'AssigningEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Namespace for the assessment.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'Namespace'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'ParticipatingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The email address for the contact.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'ElectronicMailAddress'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The conatcts''s first name', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'FirstName'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The contact''s last name', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'LastSurname'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The login ID for the user; used for security access control interface.', @level0type=N'SCHEMA', @level0name=N'edfixassessmentroster', @level1type=N'TABLE', @level1name=N'AssessmentAdministrationParticipationAdministrationContact', @level2type=N'COLUMN', @level2name=N'LoginId'
GO
