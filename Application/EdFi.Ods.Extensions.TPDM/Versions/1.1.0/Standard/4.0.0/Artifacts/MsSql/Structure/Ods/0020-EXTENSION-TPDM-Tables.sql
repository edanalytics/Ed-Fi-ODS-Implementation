...
CREATE TABLE [tpdm].[Evaluation] (
    ...
    [SchoolYear] [SMALLINT] NOT NULL,
    [TermDescriptorId] [INT] NOT NULL,
    [EvaluationDescription] [NVARCHAR](300) NULL,
    [EvaluationIdentifier] [NVARCHAR](24) NULL,
...
CREATE TABLE [tpdm].[EvaluationElement] (
    ...
    [EvaluationObjectiveTitle] [NVARCHAR](75) NOT NULL,
    [EvaluationPeriodDescriptorId] [INT] NOT NULL,
    [EvaluationTitle] [NVARCHAR](50) NOT NULL,
    [PerformanceEvaluationTitle] [NVARCHAR](50) NOT NULL,
    [PerformanceEvaluationTypeDescriptorId] [INT] NOT NULL,
    [SchoolYear] [SMALLINT] NOT NULL,
    [TermDescriptorId] [INT] NOT NULL,
    [EvaluationElementDescription] [NVARCHAR](300) NULL,
    [EvaluationIdentifier] [NVARCHAR](24) NULL,
    [EvaluationTypeDescriptorId] [INT] NULL,
    [MaxRating] [DECIMAL](6, 3) NULL,
    [MinRating] [DECIMAL](6, 3) NULL,
...
CREATE TABLE [tpdm].[EvaluationElementRatingFeedback] (
    ...
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [EvaluationElementRatingFeedback_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [EvaluationDate] ASC,
        [EvaluationElementTitle] ASC,
        [EvaluationObjectiveTitle] ASC,
        ...
        [SourceSystemDescriptorId] ASC,
        [TermDescriptorId] ASC,
        [FeedbackTypeDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [tpdm].[EvaluationElementRatingFeedback] ADD CONSTRAINT [EvaluationElementRatingFeedback_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tpdm].[EvaluationObjective] (
    ...
    [TermDescriptorId] [INT] NOT NULL,
    [EvaluationIdentifier] [NVARCHAR](24) NULL,
    [EvaluationObjectiveDescription] [NVARCHAR](300) NULL,
    [EvaluationTypeDescriptorId] [INT] NULL,
    [MaxRating] [DECIMAL](6, 3) NULL,
    [MinRating] [DECIMAL](6, 3) NULL,
    [SortOrder] [INT] NULL,
...
CREATE TABLE [tpdm].[EvaluationRatingFeedback] (
    ...
    [Comment] [NVARCHAR](1024) NOT NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [EvaluationRatingFeedback_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [EvaluationDate] ASC,
        [EvaluationPeriodDescriptorId] ASC,
        [EvaluationTitle] ASC,
...
GO
ALTER TABLE [tpdm].[EvaluationRatingFeedback] ADD CONSTRAINT [EvaluationRatingFeedback_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tpdm].[EvaluationRatingGradeLevel] (
    ...
    [GradeLevelDescriptorId] [INT] NOT NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    CONSTRAINT [EvaluationRatingGradeLevel_PK] PRIMARY KEY CLUSTERED (
        [EducationOrganizationId] ASC,
        [EvaluationDate] ASC,
        [EvaluationPeriodDescriptorId] ASC,
        [EvaluationTitle] ASC,
...
GO
ALTER TABLE [tpdm].[EvaluationRatingGradeLevel] ADD CONSTRAINT [EvaluationRatingGradeLevel_DF_CreateDate] DEFAULT (getdate()) FOR [CreateDate]
GO
...
CREATE TABLE [tpdm].[FeedbackTypeDescriptor] (
    [FeedbackTypeDescriptorId] [INT] NOT NULL,
    CONSTRAINT [FeedbackTypeDescriptor_PK] PRIMARY KEY CLUSTERED (
        [FeedbackTypeDescriptorId] ASC
    ) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [tpdm].[Goal] (
    ...
    [EvaluationObjectiveTitle] [NVARCHAR](75) NULL,
...
CREATE TABLE [tpdm].[PerformanceEvaluation] (
    ...
    [AcademicSubjectDescriptorId] [INT] NULL,
    [EvaluationIdentifier] [NVARCHAR](24) NULL,
    [PerformanceEvaluationDescription] [NVARCHAR](300) NULL,
    [Discriminator] [NVARCHAR](128) NULL,
    [CreateDate] [DATETIME2] NOT NULL,
    [LastModifiedDate] [DATETIME2] NOT NULL,
    [Id] [UNIQUEIDENTIFIER] NOT NULL,
