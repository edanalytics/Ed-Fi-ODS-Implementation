...
COMMENT ON COLUMN tpdm.Evaluation.EvaluationIdentifier IS 'Identifier that allows evaluation elements to be cross-walked across different versions.';
...
COMMENT ON COLUMN tpdm.EvaluationElement.EvaluationElementDescription IS 'The long description of the Evaluation Element.';
COMMENT ON COLUMN tpdm.EvaluationElement.EvaluationIdentifier IS 'Identifier that allows evaluation elements to be cross-walked across different versions.';
...
COMMENT ON COLUMN tpdm.EvaluationObjective.EvaluationIdentifier IS 'Identifier that allows evaluation elements to be cross-walked across different versions.';
...
COMMENT ON COLUMN tpdm.PerformanceEvaluation.EvaluationIdentifier IS 'Identifier that allows evaluation elements to be cross-walked across different versions.';
