...
GO
ALTER TABLE [tpdm].[ApplicantProfile] ADD CONSTRAINT [ApplicantProfile_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[ApplicantProfile] ADD CONSTRAINT [ApplicantProfile_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[ApplicantProfile] ADD CONSTRAINT [ApplicantProfile_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileAddress] ADD CONSTRAINT [ApplicantProfileAddress_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileAddressPeriod] ADD CONSTRAINT [ApplicantProfileAddressPeriod_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileApplicantCharacteristic] ADD CONSTRAINT [ApplicantProfileApplicantCharacteristic_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileBackgroundCheck] ADD CONSTRAINT [ApplicantProfileBackgroundCheck_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileDisability] ADD CONSTRAINT [ApplicantProfileDisability_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileDisabilityDesignation] ADD CONSTRAINT [ApplicantProfileDisabilityDesignation_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileEducatorPreparationProgramName] ADD CONSTRAINT [ApplicantProfileEducatorPreparationProgramName_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileElectronicMail] ADD CONSTRAINT [ApplicantProfileElectronicMail_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileGradePointAverage] ADD CONSTRAINT [ApplicantProfileGradePointAverage_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileHighlyQualifiedAcademicSubject] ADD CONSTRAINT [ApplicantProfileHighlyQualifiedAcademicSubject_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileIdentificationDocument] ADD CONSTRAINT [ApplicantProfileIdentificationDocument_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileInternationalAddress] ADD CONSTRAINT [ApplicantProfileInternationalAddress_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileLanguage] ADD CONSTRAINT [ApplicantProfileLanguage_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileLanguageUse] ADD CONSTRAINT [ApplicantProfileLanguageUse_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfilePersonalIdentificationDocument] ADD CONSTRAINT [ApplicantProfilePersonalIdentificationDocument_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileRace] ADD CONSTRAINT [ApplicantProfileRace_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileTelephone] ADD CONSTRAINT [ApplicantProfileTelephone_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicantProfileVisa] ADD CONSTRAINT [ApplicantProfileVisa_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[Application] ADD CONSTRAINT [Application_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[Application] ADD CONSTRAINT [Application_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[Application] ADD CONSTRAINT [Application_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicationEvent] ADD CONSTRAINT [ApplicationEvent_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[ApplicationEvent] ADD CONSTRAINT [ApplicationEvent_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[ApplicationEvent] ADD CONSTRAINT [ApplicationEvent_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicationRecruitmentEventAttendance] ADD CONSTRAINT [ApplicationRecruitmentEventAttendance_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicationScoreResult] ADD CONSTRAINT [ApplicationScoreResult_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ApplicationTerm] ADD CONSTRAINT [ApplicationTerm_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[AssessmentExtension] ADD CONSTRAINT [AssessmentExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateAid] ADD CONSTRAINT [CandidateAid_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateBackgroundCheck] ADD CONSTRAINT [CandidateBackgroundCheck_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateCharacteristic] ADD CONSTRAINT [CandidateCharacteristic_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateCohortYear] ADD CONSTRAINT [CandidateCohortYear_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateDegreeSpecialization] ADD CONSTRAINT [CandidateDegreeSpecialization_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateEducatorPreparationProgramAssociationCandidateIndicator] ADD CONSTRAINT [CandidateEducatorPreparationProgramAssociationCandidateIndicator_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateEducatorPreparationProgramAssociationCandidateIndicatorPeriod] ADD CONSTRAINT [CandidateEducatorPreparationProgramAssociationCandidateIndicatorPeriod_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateEPPProgramDegree] ADD CONSTRAINT [CandidateEPPProgramDegree_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateIdentificationCode] ADD CONSTRAINT [CandidateIdentificationCode_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateIdentificationDocument] ADD CONSTRAINT [CandidateIdentificationDocument_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateIndicator] ADD CONSTRAINT [CandidateIndicator_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateIndicatorPeriod] ADD CONSTRAINT [CandidateIndicatorPeriod_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateInternationalAddress] ADD CONSTRAINT [CandidateInternationalAddress_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateRelationshipToStaffAssociation] ADD CONSTRAINT [CandidateRelationshipToStaffAssociation_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateRelationshipToStaffAssociation] ADD CONSTRAINT [CandidateRelationshipToStaffAssociation_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[CandidateVisa] ADD CONSTRAINT [CandidateVisa_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[Certification] ADD CONSTRAINT [Certification_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[Certification] ADD CONSTRAINT [Certification_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[Certification] ADD CONSTRAINT [Certification_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[CertificationCertificationExam] ADD CONSTRAINT [CertificationCertificationExam_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CertificationExam] ADD CONSTRAINT [CertificationExam_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[CertificationExam] ADD CONSTRAINT [CertificationExam_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[CertificationExam] ADD CONSTRAINT [CertificationExam_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
CREATE TABLE [tpdm].[CertificationExamResult] (
    ...
    [CertificationExamAssessmentIdentifier] [NVARCHAR](60) NULL,
    ...
    [CertificationExamStudentAssessmentIdentifier] [NVARCHAR](60) NULL,
...
GO
ALTER TABLE [tpdm].[CertificationExamResult] ADD CONSTRAINT [CertificationExamResult_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[CertificationExamResult] ADD CONSTRAINT [CertificationExamResult_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[CertificationExamResult] ADD CONSTRAINT [CertificationExamResult_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[CertificationGradeLevel] ADD CONSTRAINT [CertificationGradeLevel_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CertificationRoute] ADD CONSTRAINT [CertificationRoute_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[CredentialEvent] ADD CONSTRAINT [CredentialEvent_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[CredentialEvent] ADD CONSTRAINT [CredentialEvent_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[CredentialEvent] ADD CONSTRAINT [CredentialEvent_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[FieldworkExperience] ADD CONSTRAINT [FieldworkExperience_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[FieldworkExperience] ADD CONSTRAINT [FieldworkExperience_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[FieldworkExperience] ADD CONSTRAINT [FieldworkExperience_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[FieldworkExperienceCoteaching] ADD CONSTRAINT [FieldworkExperienceCoteaching_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[FieldworkExperienceSectionAssociation] ADD CONSTRAINT [FieldworkExperienceSectionAssociation_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[FieldworkExperienceSectionAssociation] ADD CONSTRAINT [FieldworkExperienceSectionAssociation_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[Goal] ADD CONSTRAINT [Goal_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[Goal] ADD CONSTRAINT [Goal_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[Goal] ADD CONSTRAINT [Goal_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[GraduationPlanRequiredCertification] ADD CONSTRAINT [GraduationPlanRequiredCertification_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[LocalEducationAgencyExtension] ADD CONSTRAINT [LocalEducationAgencyExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
-- Table [tpdm].[OldEthnicityDescriptor] --
CREATE TABLE [tpdm].[OldEthnicityDescriptor] (
...
GO
ALTER TABLE [tpdm].[OpenStaffPositionEvent] ADD CONSTRAINT [OpenStaffPositionEvent_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[OpenStaffPositionEvent] ADD CONSTRAINT [OpenStaffPositionEvent_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[OpenStaffPositionEvent] ADD CONSTRAINT [OpenStaffPositionEvent_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[OpenStaffPositionExtension] ADD CONSTRAINT [OpenStaffPositionExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[Path] ADD CONSTRAINT [Path_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[Path] ADD CONSTRAINT [Path_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[Path] ADD CONSTRAINT [Path_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO

-- Table [tpdm].[PathMilestone] --
CREATE TABLE [tpdm].[PathMilestone] (
...
GO
ALTER TABLE [tpdm].[PathMilestone] ADD CONSTRAINT [PathMilestone_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[PathMilestone] ADD CONSTRAINT [PathMilestone_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[PathMilestone] ADD CONSTRAINT [PathMilestone_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO

-- Table [tpdm].[PathMilestoneStatusDescriptor] --
CREATE TABLE [tpdm].[PathMilestoneStatusDescriptor] (
...
-- Table [tpdm].[PathMilestoneTypeDescriptor] --
CREATE TABLE [tpdm].[PathMilestoneTypeDescriptor] (
    [PathMilestoneTypeDescriptorId] [INT] NOT NULL,
...
-- Table [tpdm].[PathPhase] --
CREATE TABLE [tpdm].[PathPhase] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
...
GO
ALTER TABLE [tpdm].[PathPhase] ADD CONSTRAINT [PathPhase_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[PathPhase] ADD CONSTRAINT [PathPhase_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[PathPhase] ADD CONSTRAINT [PathPhase_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO

-- Table [tpdm].[PathPhasePathMilestone] --
CREATE TABLE [tpdm].[PathPhasePathMilestone] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
    [PathPhaseName] [NVARCHAR](60) NOT NULL,
    [PathMilestoneName] [NVARCHAR](60) NOT NULL,
...
GO
ALTER TABLE [tpdm].[PathPhasePathMilestone] ADD CONSTRAINT [PathPhasePathMilestone_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO

-- Table [tpdm].[PathPhaseStatusDescriptor] --
CREATE TABLE [tpdm].[PathPhaseStatusDescriptor] (
...
GO
ALTER TABLE [tpdm].[PerformanceEvaluationProgramGateway] ADD CONSTRAINT [PerformanceEvaluationProgramGateway_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[PostSecondaryInstitutionExtension] ADD CONSTRAINT [PostSecondaryInstitutionExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ProfessionalDevelopmentEvent] ADD CONSTRAINT [ProfessionalDevelopmentEvent_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[ProfessionalDevelopmentEvent] ADD CONSTRAINT [ProfessionalDevelopmentEvent_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[ProfessionalDevelopmentEvent] ADD CONSTRAINT [ProfessionalDevelopmentEvent_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[ProfessionalDevelopmentEventAttendance] ADD CONSTRAINT [ProfessionalDevelopmentEventAttendance_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[ProfessionalDevelopmentEventAttendance] ADD CONSTRAINT [ProfessionalDevelopmentEventAttendance_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[QuantitativeMeasure] ADD CONSTRAINT [QuantitativeMeasure_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[QuantitativeMeasure] ADD CONSTRAINT [QuantitativeMeasure_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[QuantitativeMeasure] ADD CONSTRAINT [QuantitativeMeasure_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[QuantitativeMeasureScore] ADD CONSTRAINT [QuantitativeMeasureScore_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[QuantitativeMeasureScore] ADD CONSTRAINT [QuantitativeMeasureScore_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[QuantitativeMeasureScore] ADD CONSTRAINT [QuantitativeMeasureScore_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEvent] ADD CONSTRAINT [RecruitmentEvent_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[RecruitmentEvent] ADD CONSTRAINT [RecruitmentEvent_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[RecruitmentEvent] ADD CONSTRAINT [RecruitmentEvent_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendance] ADD CONSTRAINT [RecruitmentEventAttendance_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendance] ADD CONSTRAINT [RecruitmentEventAttendance_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendance] ADD CONSTRAINT [RecruitmentEventAttendance_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendanceCurrentPosition] ADD CONSTRAINT [RecruitmentEventAttendanceCurrentPosition_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendanceCurrentPositionGradeLevel] ADD CONSTRAINT [RecruitmentEventAttendanceCurrentPositionGradeLevel_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendanceDisability] ADD CONSTRAINT [RecruitmentEventAttendanceDisability_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendanceDisabilityDesignation] ADD CONSTRAINT [RecruitmentEventAttendanceDisabilityDesignation_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendancePersonalIdentificationDocument] ADD CONSTRAINT [RecruitmentEventAttendancePersonalIdentificationDocument_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendanceRace] ADD CONSTRAINT [RecruitmentEventAttendanceRace_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendanceRecruitmentEventAttendeeQualifications] ADD CONSTRAINT [RecruitmentEventAttendanceRecruitmentEventAttendeeQualifications_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendanceTelephone] ADD CONSTRAINT [RecruitmentEventAttendanceTelephone_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[RecruitmentEventAttendanceTouchpoint] ADD CONSTRAINT [RecruitmentEventAttendanceTouchpoint_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducationOrganizationAssignmentAssociationExtension] ADD CONSTRAINT [StaffEducationOrganizationAssignmentAssociationExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducationOrganizationEmploymentAssociationBackgroundCheck] ADD CONSTRAINT [StaffEducationOrganizationEmploymentAssociationBackgroundCheck_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducationOrganizationEmploymentAssociationExtension] ADD CONSTRAINT [StaffEducationOrganizationEmploymentAssociationExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducationOrganizationEmploymentAssociationSalary] ADD CONSTRAINT [StaffEducationOrganizationEmploymentAssociationSalary_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducationOrganizationEmploymentAssociationSeniority] ADD CONSTRAINT [StaffEducationOrganizationEmploymentAssociationSeniority_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducatorPreparationProgram] ADD CONSTRAINT [StaffEducatorPreparationProgram_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducatorPreparationProgramAssociation] ADD CONSTRAINT [StaffEducatorPreparationProgramAssociation_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducatorPreparationProgramAssociation] ADD CONSTRAINT [StaffEducatorPreparationProgramAssociation_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffEducatorResearch] ADD CONSTRAINT [StaffEducatorResearch_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffExtension] ADD CONSTRAINT [StaffExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StaffHighlyQualifiedAcademicSubject] ADD CONSTRAINT [StaffHighlyQualifiedAcademicSubject_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StateEducationAgencyExtension] ADD CONSTRAINT [StateEducationAgencyExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[StudentGradebookEntryExtension] ADD CONSTRAINT [StudentGradebookEntryExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO

-- Table [tpdm].[StudentPath] --
CREATE TABLE [tpdm].[StudentPath] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [Discriminator] [NVARCHAR](128) NULL,
...
GO
ALTER TABLE [tpdm].[StudentPath] ADD CONSTRAINT [StudentPath_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[StudentPath] ADD CONSTRAINT [StudentPath_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[StudentPath] ADD CONSTRAINT [StudentPath_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO

-- Table [tpdm].[StudentPathMilestoneStatus] --
CREATE TABLE [tpdm].[StudentPathMilestoneStatus] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathMilestoneName] [NVARCHAR](60) NOT NULL,
    [PathMilestoneTypeDescriptorId] [INT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
...
GO
ALTER TABLE [tpdm].[StudentPathMilestoneStatus] ADD CONSTRAINT [StudentPathMilestoneStatus_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[StudentPathMilestoneStatus] ADD CONSTRAINT [StudentPathMilestoneStatus_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[StudentPathMilestoneStatus] ADD CONSTRAINT [StudentPathMilestoneStatus_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO

-- Table [tpdm].[StudentPathMilestoneStatusEvent] --
CREATE TABLE [tpdm].[StudentPathMilestoneStatusEvent] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathMilestoneName] [NVARCHAR](60) NOT NULL,
    [PathMilestoneTypeDescriptorId] [INT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
...
GO
ALTER TABLE [tpdm].[StudentPathMilestoneStatusEvent] ADD CONSTRAINT [StudentPathMilestoneStatusEvent_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO

-- Table [tpdm].[StudentPathPeriod] --
CREATE TABLE [tpdm].[StudentPathPeriod] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
    [StudentUSI] [INT] NOT NULL,
    [BeginDate] [DATE] NOT NULL,
...
GO
ALTER TABLE [tpdm].[StudentPathPeriod] ADD CONSTRAINT [StudentPathPeriod_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO

-- Table [tpdm].[StudentPathPhaseStatus] --
CREATE TABLE [tpdm].[StudentPathPhaseStatus] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
    [PathPhaseName] [NVARCHAR](60) NOT NULL,
    [StudentUSI] [INT] NOT NULL,
...
GO
ALTER TABLE [tpdm].[StudentPathPhaseStatus] ADD CONSTRAINT [StudentPathPhaseStatus_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[StudentPathPhaseStatus] ADD CONSTRAINT [StudentPathPhaseStatus_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[StudentPathPhaseStatus] ADD CONSTRAINT [StudentPathPhaseStatus_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO

-- Table [tpdm].[StudentPathPhaseStatusEvent] --
CREATE TABLE [tpdm].[StudentPathPhaseStatusEvent] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
    [PathPhaseName] [NVARCHAR](60) NOT NULL,
    [StudentUSI] [INT] NOT NULL,
...
GO
ALTER TABLE [tpdm].[StudentPathPhaseStatusEvent] ADD CONSTRAINT [StudentPathPhaseStatusEvent_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO

-- Table [tpdm].[StudentPathPhaseStatusPeriod] --
CREATE TABLE [tpdm].[StudentPathPhaseStatusPeriod] (
    [EducationOrganizationId] [BIGINT] NOT NULL,
    [PathName] [NVARCHAR](60) NOT NULL,
    [PathPhaseName] [NVARCHAR](60) NOT NULL,
    [StudentUSI] [INT] NOT NULL,
...
GO
ALTER TABLE [tpdm].[StudentPathPhaseStatusPeriod] ADD CONSTRAINT [StudentPathPhaseStatusPeriod_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
...
GO
ALTER TABLE [tpdm].[SurveySectionAggregateResponse] ADD CONSTRAINT [SurveySectionAggregateResponse_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
ALTER TABLE [tpdm].[SurveySectionAggregateResponse] ADD CONSTRAINT [SurveySectionAggregateResponse_DF_Id] DEFAULT (newid()) FOR [Id]
GO
ALTER TABLE [tpdm].[SurveySectionAggregateResponse] ADD CONSTRAINT [SurveySectionAggregateResponse_DF_LastModifiedDate] DEFAULT (getutcdate()) FOR [LastModifiedDate]
GO
...
GO
ALTER TABLE [tpdm].[SurveySectionExtension] ADD CONSTRAINT [SurveySectionExtension_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
