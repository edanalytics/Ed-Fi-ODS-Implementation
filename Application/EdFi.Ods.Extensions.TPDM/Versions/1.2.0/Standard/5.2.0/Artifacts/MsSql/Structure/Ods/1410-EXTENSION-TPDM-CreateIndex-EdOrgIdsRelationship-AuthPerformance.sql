...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_Path_EducationOrganizationId' AND object_id = OBJECT_ID('tpdm.Path')) 
BEGIN
    CREATE INDEX IX_Path_EducationOrganizationId ON [tpdm].[Path](EducationOrganizationId) INCLUDE (Id)
END;

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_PathPhase_EducationOrganizationId' AND object_id = OBJECT_ID('tpdm.PathPhase')) 
BEGIN
    CREATE INDEX IX_PathPhase_EducationOrganizationId ON [tpdm].[PathPhase](EducationOrganizationId) INCLUDE (Id)
END;
...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_StudentPath_EducationOrganizationId' AND object_id = OBJECT_ID('tpdm.StudentPath')) 
BEGIN
    CREATE INDEX IX_StudentPath_EducationOrganizationId ON [tpdm].[StudentPath](EducationOrganizationId) INCLUDE (Id)
END;

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_StudentPathMilestoneStatus_EducationOrganizationId' AND object_id = OBJECT_ID('tpdm.StudentPathMilestoneStatus')) 
BEGIN
    CREATE INDEX IX_StudentPathMilestoneStatus_EducationOrganizationId ON [tpdm].[StudentPathMilestoneStatus](EducationOrganizationId) INCLUDE (Id)
END;

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_StudentPathPhaseStatus_EducationOrganizationId' AND object_id = OBJECT_ID('tpdm.StudentPathPhaseStatus')) 
BEGIN
    CREATE INDEX IX_StudentPathPhaseStatus_EducationOrganizationId ON [tpdm].[StudentPathPhaseStatus](EducationOrganizationId) INCLUDE (Id)
END;
