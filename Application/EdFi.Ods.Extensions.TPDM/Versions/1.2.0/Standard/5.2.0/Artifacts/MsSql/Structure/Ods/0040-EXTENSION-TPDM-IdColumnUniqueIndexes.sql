...
BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.Path') AND name = N'UX_Path_Id')
    CREATE UNIQUE NONCLUSTERED INDEX UX_Path_Id ON [tpdm].[Path]
    (Id) WITH (PAD_INDEX = ON, FILLFACTOR = 75, STATISTICS_NORECOMPUTE = OFF) ON [PRIMARY]
    GO
COMMIT

BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.PathMilestone') AND name = N'UX_PathMilestone_Id')
    CREATE UNIQUE NONCLUSTERED INDEX UX_PathMilestone_Id ON [tpdm].[PathMilestone]
    (Id) WITH (PAD_INDEX = ON, FILLFACTOR = 75, STATISTICS_NORECOMPUTE = OFF) ON [PRIMARY]
    GO
COMMIT

BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.PathPhase') AND name = N'UX_PathPhase_Id')
    CREATE UNIQUE NONCLUSTERED INDEX UX_PathPhase_Id ON [tpdm].[PathPhase]
    (Id) WITH (PAD_INDEX = ON, FILLFACTOR = 75, STATISTICS_NORECOMPUTE = OFF) ON [PRIMARY]
    GO
COMMIT
...
BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.StudentPath') AND name = N'UX_StudentPath_Id')
    CREATE UNIQUE NONCLUSTERED INDEX UX_StudentPath_Id ON [tpdm].[StudentPath]
    (Id) WITH (PAD_INDEX = ON, FILLFACTOR = 75, STATISTICS_NORECOMPUTE = OFF) ON [PRIMARY]
    GO
COMMIT

BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.StudentPathMilestoneStatus') AND name = N'UX_StudentPathMilestoneStatus_Id')
    CREATE UNIQUE NONCLUSTERED INDEX UX_StudentPathMilestoneStatus_Id ON [tpdm].[StudentPathMilestoneStatus]
    (Id) WITH (PAD_INDEX = ON, FILLFACTOR = 75, STATISTICS_NORECOMPUTE = OFF) ON [PRIMARY]
    GO
COMMIT

BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.StudentPathPhaseStatus') AND name = N'UX_StudentPathPhaseStatus_Id')
    CREATE UNIQUE NONCLUSTERED INDEX UX_StudentPathPhaseStatus_Id ON [tpdm].[StudentPathPhaseStatus]
    (Id) WITH (PAD_INDEX = ON, FILLFACTOR = 75, STATISTICS_NORECOMPUTE = OFF) ON [PRIMARY]
    GO
COMMIT
