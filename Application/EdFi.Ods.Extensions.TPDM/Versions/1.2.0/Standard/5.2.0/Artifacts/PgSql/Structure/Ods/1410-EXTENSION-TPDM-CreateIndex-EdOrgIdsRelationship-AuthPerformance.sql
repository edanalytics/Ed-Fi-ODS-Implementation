...
CREATE INDEX IF NOT EXISTS IX_Path_EducationOrganizationId ON tpdm.Path(EducationOrganizationId) INCLUDE (Id);

CREATE INDEX IF NOT EXISTS IX_PathPhase_EducationOrganizationId ON tpdm.PathPhase(EducationOrganizationId) INCLUDE (Id);
...
CREATE INDEX IF NOT EXISTS IX_StudentPath_EducationOrganizationId ON tpdm.StudentPath(EducationOrganizationId) INCLUDE (Id);

CREATE INDEX IF NOT EXISTS IX_StudentPathMilestoneStatus_EducationOrganizationId ON tpdm.StudentPathMilestoneStatus(EducationOrganizationId) INCLUDE (Id);

CREATE INDEX IF NOT EXISTS IX_StudentPathPhaseStatus_EducationOrganizationId ON tpdm.StudentPathPhaseStatus(EducationOrganizationId) INCLUDE (Id);
