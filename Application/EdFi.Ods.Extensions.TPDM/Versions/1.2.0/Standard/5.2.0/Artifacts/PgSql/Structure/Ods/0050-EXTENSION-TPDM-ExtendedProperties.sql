...
COMMENT ON COLUMN tpdm.ApplicantProfile.PreferredFirstName IS 'The first name the individual prefers, if different from their legal first name';
COMMENT ON COLUMN tpdm.ApplicantProfile.PreferredLastSurname IS 'The last name the individual prefers, if different from their legal last name';
...
COMMENT ON COLUMN tpdm.ApplicantProfileAddress.NameOfCounty IS 'The name of the county, parish, borough, or comparable unit (within a state) in which an address is located.';
...
COMMENT ON COLUMN tpdm.ApplicantProfileAddressPeriod.BeginDate IS 'The month, day, and year for the start of the period.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
COMMENT ON COLUMN tpdm.ApplicantProfileAddressPeriod.EndDate IS 'The month, day, and year for the end of the period.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.ApplicantProfileInternationalAddress.BeginDate IS 'The first date the address is valid. For physical addresses, the date the individual moved to that address.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.ApplicantProfileInternationalAddress.EndDate IS 'The last date the address is valid. For physical addresses, the date the individual moved from that address.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_fc4f14.BeginDate IS 'The begin date for the association.';
...
COMMENT ON COLUMN tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_fc4f14.EndDate IS 'The month, day, and year for the end of the period.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.CandidateIndicatorPeriod.BeginDate IS 'The month, day, and year when the indicator value is valid';
COMMENT ON COLUMN tpdm.CandidateIndicatorPeriod.IndicatorName IS 'The name of the indicator or metric.';
COMMENT ON COLUMN tpdm.CandidateIndicatorPeriod.EndDate IS 'The month, day, and year for the end of the period.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.CandidateInternationalAddress.BeginDate IS 'The first date the address is valid. For physical addresses, the date the individual moved to that address.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.CandidateInternationalAddress.EndDate IS 'The last date the address is valid. For physical addresses, the date the individual moved from that address.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.CertificationExamResult.CertificationExamAssessmentIdentifier IS 'A unique number or alphanumeric code assigned to an assessment.';
COMMENT ON COLUMN tpdm.CertificationExamResult.CertificationExamNamespace IS 'Namespace for the assessment.';
...
COMMENT ON COLUMN tpdm.CertificationExamResult.CertificationExamStudentAssessmentIdentifier IS 'A unique number or alphanumeric code assigned to an assessment administered to a student.';
COMMENT ON COLUMN tpdm.CertificationExamResult.CertificationExamStudentUSI IS 'A unique alphanumeric code assigned to a student.';
...
COMMENT ON COLUMN tpdm.FieldworkExperience.SchoolId IS 'The identifier assigned to a school. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.';
...
COMMENT ON COLUMN tpdm.FieldworkExperienceSectionAssociation.SchoolId IS 'The identifier assigned to a school. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.';
...
COMMENT ON COLUMN tpdm.LocalEducationAgencyExtension.LocalEducationAgencyId IS 'The identifier assigned to a local education agency. It must be distinct from any other identifier assigned to educational organizations, such as a SchoolId, to prevent duplication.';
...
COMMENT ON TABLE tpdm.OldEthnicityDescriptor IS 'Previous definition of Ethnicity combining Hispanic/Latino and Race.';
COMMENT ON COLUMN tpdm.OldEthnicityDescriptor.OldEthnicityDescriptorId IS 'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.';
...
COMMENT ON TABLE tpdm.Path IS 'A scheme for achieving milestones organized by phases for students to follow and be tracked against.';
COMMENT ON COLUMN tpdm.Path.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.Path.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.Path.GraduationPlanTypeDescriptorId IS 'The type of academic plan the student is following for graduation.';
COMMENT ON COLUMN tpdm.Path.GraduationSchoolYear IS 'The school year the student is expected to graduate.';

-- Extended Properties [tpdm].[PathMilestone] --
COMMENT ON TABLE tpdm.PathMilestone IS 'A significant event or achievement as part of a path.';
COMMENT ON COLUMN tpdm.PathMilestone.PathMilestoneName IS 'The descriptive name of the milestone.';
COMMENT ON COLUMN tpdm.PathMilestone.PathMilestoneTypeDescriptorId IS 'The type of milestone defined for the student''s path.';
COMMENT ON COLUMN tpdm.PathMilestone.PathMilestoneCode IS 'The code or identifier associated with an element associated with the path milestone (e.g., course, certification, etc)';
COMMENT ON COLUMN tpdm.PathMilestone.PathMilestoneDescription IS 'Additional information describing the path''s milestone to be achieved.';

-- Extended Properties [tpdm].[PathMilestoneStatusDescriptor] --
COMMENT ON TABLE tpdm.PathMilestoneStatusDescriptor IS 'The student''s status associated with the path milestone.';
COMMENT ON COLUMN tpdm.PathMilestoneStatusDescriptor.PathMilestoneStatusDescriptorId IS 'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.';

-- Extended Properties [tpdm].[PathMilestoneTypeDescriptor] --
COMMENT ON TABLE tpdm.PathMilestoneTypeDescriptor IS 'The type of milestone defined for the student''s path.';
COMMENT ON COLUMN tpdm.PathMilestoneTypeDescriptor.PathMilestoneTypeDescriptorId IS 'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.';

-- Extended Properties [tpdm].[PathPhase] --
COMMENT ON TABLE tpdm.PathPhase IS 'A stage in the process of a student achieving milestones.';
COMMENT ON COLUMN tpdm.PathPhase.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.PathPhase.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.PathPhase.PathPhaseName IS 'The name of the phase associated with the path.';
COMMENT ON COLUMN tpdm.PathPhase.PathPhaseSequence IS 'Indicates the number in order, starting with 1, that the phases are organized into.';
COMMENT ON COLUMN tpdm.PathPhase.PhasePathDescription IS 'Additional information describing the path''s phase';

-- Extended Properties [tpdm].[PathPhasePathMilestone] --
COMMENT ON TABLE tpdm.PathPhasePathMilestone IS 'A reference to the path milestones associated with this phase';
COMMENT ON COLUMN tpdm.PathPhasePathMilestone.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.PathPhasePathMilestone.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.PathPhasePathMilestone.PathPhaseName IS 'The name of the phase associated with the path.';
COMMENT ON COLUMN tpdm.PathPhasePathMilestone.PathMilestoneName IS 'The descriptive name of the milestone.';
COMMENT ON COLUMN tpdm.PathPhasePathMilestone.PathMilestoneTypeDescriptorId IS 'The type of milestone defined for the student''s path.';

-- Extended Properties [tpdm].[PathPhaseStatusDescriptor] --
COMMENT ON TABLE tpdm.PathPhaseStatusDescriptor IS 'The student''s status associated with entering or completing the phase.';
COMMENT ON COLUMN tpdm.PathPhaseStatusDescriptor.PathPhaseStatusDescriptorId IS 'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.';
...
COMMENT ON COLUMN tpdm.PostSecondaryInstitutionExtension.PostSecondaryInstitutionId IS 'The ID of the post secondary institution. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.';
...
COMMENT ON COLUMN tpdm.RecruitmentEventAttendance.PreferredFirstName IS 'The first name the individual prefers, if different from their legal first name';
COMMENT ON COLUMN tpdm.RecruitmentEventAttendance.PreferredLastSurname IS 'The last name the individual prefers, if different from their legal last name';
...
COMMENT ON COLUMN tpdm.StaffEducationOrganizationAssignmentAssociationExtension.BeginDate IS 'Month, day, and year of the start or effective date of a staff member''s employment, contract, or relationship with the education organization.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.StaffEducationOrganizationEmploymentAssociationBackgroundCheck.HireDate IS 'The month, day, and year on which an individual was hired for a position.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.StaffEducationOrganizationEmploymentAssociationExtension.HireDate IS 'The month, day, and year on which an individual was hired for a position.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.StaffEducationOrganizationEmploymentAssociationSalary.HireDate IS 'The month, day, and year on which an individual was hired for a position.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.StaffEducationOrganizationEmploymentAssociationSeniority.HireDate IS 'The month, day, and year on which an individual was hired for a position.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
...
COMMENT ON COLUMN tpdm.StateEducationAgencyExtension.StateEducationAgencyId IS 'The identifier assigned to a state education agency. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.';
...
COMMENT ON COLUMN tpdm.StudentGradebookEntryExtension.GradebookEntryIdentifier IS 'A unique number or alphanumeric code assigned to a gradebook entry by the source system.';
COMMENT ON COLUMN tpdm.StudentGradebookEntryExtension.Namespace IS 'Namespace URI for the source of the gradebook entry.';
...
COMMENT ON TABLE tpdm.StudentPath IS 'The entity representing the association or assignment of the student to the path being pursued.';
COMMENT ON COLUMN tpdm.StudentPath.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.StudentPath.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.StudentPath.StudentUSI IS 'A unique alphanumeric code assigned to a student.';

-- Extended Properties [tpdm].[StudentPathMilestoneStatus] --
COMMENT ON TABLE tpdm.StudentPathMilestoneStatus IS 'The status of the student''s achievement of the path milestone.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatus.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatus.PathMilestoneName IS 'The descriptive name of the milestone.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatus.PathMilestoneTypeDescriptorId IS 'The type of milestone defined for the student''s path.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatus.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatus.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatus.CompletionIndicator IS 'Indicator on whether the student has completed the path milestone.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatus.PathPhaseName IS 'The name of the phase associated with the path.';

-- Extended Properties [tpdm].[StudentPathMilestoneStatusEvent] --
COMMENT ON TABLE tpdm.StudentPathMilestoneStatusEvent IS 'The student''s milestone status and the date of the status change.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatusEvent.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatusEvent.PathMilestoneName IS 'The descriptive name of the milestone.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatusEvent.PathMilestoneTypeDescriptorId IS 'The type of milestone defined for the student''s path.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatusEvent.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatusEvent.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatusEvent.Description IS 'Additional information associated with the milestone status achieved.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatusEvent.PathMilestoneStatusDate IS 'The month, day and year associated with the change in the path milestone status.';
COMMENT ON COLUMN tpdm.StudentPathMilestoneStatusEvent.PathMilestoneStatusDescriptorId IS 'The student''s status associated with the Path milestone.';

-- Extended Properties [tpdm].[StudentPathPeriod] --
COMMENT ON TABLE tpdm.StudentPathPeriod IS 'The time periods for which the student was assigned and pursing the path.';
COMMENT ON COLUMN tpdm.StudentPathPeriod.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.StudentPathPeriod.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.StudentPathPeriod.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
COMMENT ON COLUMN tpdm.StudentPathPeriod.BeginDate IS 'The month, day, and year for the start of the period.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
COMMENT ON COLUMN tpdm.StudentPathPeriod.EndDate IS 'The month, day, and year for the end of the period.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';

-- Extended Properties [tpdm].[StudentPathPhaseStatus] --
COMMENT ON TABLE tpdm.StudentPathPhaseStatus IS 'The status of the student''s association with the path''s phase.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatus.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatus.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatus.PathPhaseName IS 'The name of the phase associated with the path.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatus.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatus.CompletionIndicator IS 'Indicator on whether the student has completed the phase associated with the path.';

-- Extended Properties [tpdm].[StudentPathPhaseStatusEvent] --
COMMENT ON TABLE tpdm.StudentPathPhaseStatusEvent IS 'The student''s phase status and the date of the status change.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusEvent.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusEvent.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusEvent.PathPhaseName IS 'The name of the phase associated with the path.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusEvent.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusEvent.PathPhaseStatusDate IS 'The month, day and year on which the status was achieved for the phase';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusEvent.PathPhaseStatusDescriptorId IS 'The student''s status associated with entering or completing the phase';

-- Extended Properties [tpdm].[StudentPathPhaseStatusPeriod] --
COMMENT ON TABLE tpdm.StudentPathPhaseStatusPeriod IS 'The time periods associated with the phase status.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusPeriod.EducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusPeriod.PathName IS 'The name of the path.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusPeriod.PathPhaseName IS 'The name of the phase associated with the path.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusPeriod.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusPeriod.BeginDate IS 'The month, day, and year for the start of the period.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusPeriod.EndDate IS 'The month, day, and year for the end of the period.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
