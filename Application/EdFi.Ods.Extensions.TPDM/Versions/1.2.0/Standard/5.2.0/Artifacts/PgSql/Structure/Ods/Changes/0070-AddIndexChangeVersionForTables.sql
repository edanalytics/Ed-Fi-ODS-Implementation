...
CREATE INDEX IF NOT EXISTS UX_62fa5a_ChangeVersion ON tpdm.Path(ChangeVersion);

CREATE INDEX IF NOT EXISTS UX_63a11e_ChangeVersion ON tpdm.PathMilestone(ChangeVersion);

CREATE INDEX IF NOT EXISTS UX_94a0ce_ChangeVersion ON tpdm.PathPhase(ChangeVersion);
...
CREATE INDEX IF NOT EXISTS UX_efd39c_ChangeVersion ON tpdm.StudentPath(ChangeVersion);

CREATE INDEX IF NOT EXISTS UX_bffe71_ChangeVersion ON tpdm.StudentPathMilestoneStatus(ChangeVersion);

CREATE INDEX IF NOT EXISTS UX_a174cf_ChangeVersion ON tpdm.StudentPathPhaseStatus(ChangeVersion);
