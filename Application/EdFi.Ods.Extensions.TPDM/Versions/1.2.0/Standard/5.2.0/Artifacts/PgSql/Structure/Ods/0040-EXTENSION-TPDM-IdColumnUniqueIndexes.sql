...
CREATE UNIQUE INDEX IF NOT EXISTS UX_62fa5a_Id ON tpdm.Path(Id);

CREATE UNIQUE INDEX IF NOT EXISTS UX_63a11e_Id ON tpdm.PathMilestone(Id);

CREATE UNIQUE INDEX IF NOT EXISTS UX_94a0ce_Id ON tpdm.PathPhase(Id);
...
CREATE UNIQUE INDEX IF NOT EXISTS UX_efd39c_Id ON tpdm.StudentPath(Id);

CREATE UNIQUE INDEX IF NOT EXISTS UX_bffe71_Id ON tpdm.StudentPathMilestoneStatus(Id);

CREATE UNIQUE INDEX IF NOT EXISTS UX_a174cf_Id ON tpdm.StudentPathPhaseStatus(Id);
