...
ALTER TABLE tpdm.ApplicantProfile ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.ApplicantProfile ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.ApplicantProfile ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileAddress ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileAddressPeriod ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileApplicantCharacteristic ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileBackgroundCheck ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileDisability ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileDisabilityDesignation ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileEducatorPreparationProgramName ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileElectronicMail ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileGradePointAverage ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileHighlyQualifiedAcademicSubject ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileIdentificationDocument ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileInternationalAddress ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileLanguage ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileLanguageUse ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfilePersonalIdentificationDocument ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileRace ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileTelephone ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicantProfileVisa ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.Application ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.Application ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.Application ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicationEvent ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.ApplicationEvent ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.ApplicationEvent ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicationRecruitmentEventAttendance ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicationScoreResult ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ApplicationTerm ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.AssessmentExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
CREATE TABLE tpdm.CandidateAid (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT CandidateAid_PK PRIMARY KEY (CandidateIdentifier, AidTypeDescriptorId, BeginDate)
);
ALTER TABLE tpdm.CandidateAid ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateBackgroundCheck ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateCharacteristic ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateCohortYear ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
CREATE TABLE tpdm.CandidateDegreeSpecialization (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT CandidateDegreeSpecialization_PK PRIMARY KEY (CandidateIdentifier, BeginDate, MajorSpecialization)
);
ALTER TABLE tpdm.CandidateDegreeSpecialization ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_0d7c2b ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
CREATE TABLE tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_fc4f14 (
    ...
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT CandidateEducatorPreparationProgramAssociationCand_fc4f14_PK PRIMARY KEY (BeginDate, CandidateIdentifier, EducationOrganizationId, ProgramName, ProgramTypeDescriptorId, IndicatorName)
);
ALTER TABLE tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_fc4f14 ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateEPPProgramDegree ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateIdentificationCode ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateIdentificationDocument ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateIndicator ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
CREATE TABLE tpdm.CandidateIndicatorPeriod (
    ...
    EndDate DATE NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT CandidateIndicatorPeriod_PK PRIMARY KEY (CandidateIdentifier, BeginDate, IndicatorName)
);
ALTER TABLE tpdm.CandidateIndicatorPeriod ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateInternationalAddress ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateRelationshipToStaffAssociation ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.CandidateRelationshipToStaffAssociation ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.CandidateRelationshipToStaffAssociation ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CandidateVisa ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.Certification ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.Certification ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.Certification ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CertificationCertificationExam ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CertificationExam ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.CertificationExam ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.CertificationExam ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
CREATE TABLE tpdm.CertificationExamResult (
    ...
    CertificationExamAssessmentIdentifier VARCHAR(60) NULL,
    ...
    CertificationExamStudentAssessmentIdentifier VARCHAR(60) NULL,
...
ALTER TABLE tpdm.CertificationExamResult ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.CertificationExamResult ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.CertificationExamResult ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CertificationGradeLevel ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CertificationRoute ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.CredentialEvent ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.CredentialEvent ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.CredentialEvent ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.FieldworkExperience ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.FieldworkExperience ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.FieldworkExperience ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.FieldworkExperienceCoteaching ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.FieldworkExperienceSectionAssociation ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.FieldworkExperienceSectionAssociation ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.FieldworkExperienceSectionAssociation ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.Goal ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.Goal ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.Goal ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.GraduationPlanRequiredCertification ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.LocalEducationAgencyExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.OpenStaffPositionEvent ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.OpenStaffPositionEvent ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.OpenStaffPositionEvent ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.OpenStaffPositionExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.Path ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.Path ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.Path ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.PathMilestone ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.PathMilestone ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.PathMilestone ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.PathPhase ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.PathPhase ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.PathPhase ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.PathPhasePathMilestone ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
CREATE TABLE tpdm.PerformanceEvaluationProgramGateway (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT PerformanceEvaluationProgramGateway_PK PRIMARY KEY (EducationOrganizationId, EvaluationPeriodDescriptorId, PerformanceEvaluationTitle, PerformanceEvaluationTypeDescriptorId, SchoolYear, TermDescriptorId, ProgramGatewayDescriptorId)
);
ALTER TABLE tpdm.PerformanceEvaluationProgramGateway ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.PostSecondaryInstitutionExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ProfessionalDevelopmentEvent ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.ProfessionalDevelopmentEvent ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.ProfessionalDevelopmentEvent ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.ProfessionalDevelopmentEventAttendance ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.ProfessionalDevelopmentEventAttendance ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.ProfessionalDevelopmentEventAttendance ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.QuantitativeMeasure ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.QuantitativeMeasure ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.QuantitativeMeasure ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.QuantitativeMeasureScore ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.QuantitativeMeasureScore ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.QuantitativeMeasureScore ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEvent ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.RecruitmentEvent ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.RecruitmentEvent ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendance ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.RecruitmentEventAttendance ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.RecruitmentEventAttendance ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendanceCurrentPosition ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendanceCurrentPositionGradeLevel ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendanceDisability ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendanceDisabilityDesignation ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendancePersonalIdentificationDocument ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendanceRace ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendanceRecruitmentEventAttendeeQualif_82dbb7 ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendanceTelephone ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.RecruitmentEventAttendanceTouchpoint ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffEducationOrganizationAssignmentAssociationExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffEducationOrganizationEmploymentAssociationBackgroundCheck ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffEducationOrganizationEmploymentAssociationExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffEducationOrganizationEmploymentAssociationSalary ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffEducationOrganizationEmploymentAssociationSeniority ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffEducatorPreparationProgram ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffEducatorPreparationProgramAssociation ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.StaffEducatorPreparationProgramAssociation ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.StaffEducatorPreparationProgramAssociation ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffEducatorResearch ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StaffHighlyQualifiedAcademicSubject ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StateEducationAgencyExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StudentGradebookEntryExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StudentPath ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.StudentPath ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.StudentPath ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StudentPathMilestoneStatus ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.StudentPathMilestoneStatus ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.StudentPathMilestoneStatus ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StudentPathMilestoneStatusEvent ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StudentPathPeriod ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StudentPathPhaseStatus ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.StudentPathPhaseStatus ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.StudentPathPhaseStatus ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StudentPathPhaseStatusEvent ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.StudentPathPhaseStatusPeriod ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.SurveySectionAggregateResponse ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE tpdm.SurveySectionAggregateResponse ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE tpdm.SurveySectionAggregateResponse ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE tpdm.SurveySectionExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
