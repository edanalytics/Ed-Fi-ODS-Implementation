...
CREATE OR REPLACE FUNCTION tracked_changes_tpdm.oldethnicitydescriptor_deleted()
    RETURNS trigger AS
$BODY$
BEGIN
    INSERT INTO tracked_changes_edfi.descriptor(olddescriptorid, oldcodevalue, oldnamespace, id, discriminator, changeversion)
    SELECT OLD.OldEthnicityDescriptorId, b.codevalue, b.namespace, b.id, 'tpdm.OldEthnicityDescriptor', nextval('changes.ChangeVersionSequence')
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'oldethnicitydescriptor') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.oldethnicitydescriptor 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.oldethnicitydescriptor_deleted();
END IF;
...
CREATE OR REPLACE FUNCTION tracked_changes_tpdm.path_deleted()
    RETURNS trigger AS
$BODY$
BEGIN
    INSERT INTO tracked_changes_tpdm.path(
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'path') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.path 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.path_deleted();
END IF;

CREATE OR REPLACE FUNCTION tracked_changes_tpdm.pathmilestone_deleted()
    RETURNS trigger AS
$BODY$
DECLARE
    dj0 edfi.descriptor%ROWTYPE;
BEGIN
    ...
    INSERT INTO tracked_changes_tpdm.pathmilestone(
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'pathmilestone') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.pathmilestone 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.pathmilestone_deleted();
END IF;

CREATE OR REPLACE FUNCTION tracked_changes_tpdm.pathmilestonestatusdescriptor_deleted()
    RETURNS trigger AS
$BODY$
BEGIN
    INSERT INTO tracked_changes_edfi.descriptor(olddescriptorid, oldcodevalue, oldnamespace, id, discriminator, changeversion)
    SELECT OLD.PathMilestoneStatusDescriptorId, b.codevalue, b.namespace, b.id, 'tpdm.PathMilestoneStatusDescriptor', nextval('changes.ChangeVersionSequence')
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'pathmilestonestatusdescriptor') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.pathmilestonestatusdescriptor 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.pathmilestonestatusdescriptor_deleted();
END IF;

CREATE OR REPLACE FUNCTION tracked_changes_tpdm.pathmilestonetypedescriptor_deleted()
    RETURNS trigger AS
$BODY$
BEGIN
    INSERT INTO tracked_changes_edfi.descriptor(olddescriptorid, oldcodevalue, oldnamespace, id, discriminator, changeversion)
    SELECT OLD.PathMilestoneTypeDescriptorId, b.codevalue, b.namespace, b.id, 'tpdm.PathMilestoneTypeDescriptor', nextval('changes.ChangeVersionSequence')
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'pathmilestonetypedescriptor') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.pathmilestonetypedescriptor 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.pathmilestonetypedescriptor_deleted();
END IF;

CREATE OR REPLACE FUNCTION tracked_changes_tpdm.pathphase_deleted()
    RETURNS trigger AS
$BODY$
BEGIN
    INSERT INTO tracked_changes_tpdm.pathphase(
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'pathphase') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.pathphase 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.pathphase_deleted();
END IF;

CREATE OR REPLACE FUNCTION tracked_changes_tpdm.pathphasestatusdescriptor_deleted()
    RETURNS trigger AS
$BODY$
BEGIN
    INSERT INTO tracked_changes_edfi.descriptor(olddescriptorid, oldcodevalue, oldnamespace, id, discriminator, changeversion)
    SELECT OLD.PathPhaseStatusDescriptorId, b.codevalue, b.namespace, b.id, 'tpdm.PathPhaseStatusDescriptor', nextval('changes.ChangeVersionSequence')
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'pathphasestatusdescriptor') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.pathphasestatusdescriptor 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.pathphasestatusdescriptor_deleted();
END IF;
...
CREATE OR REPLACE FUNCTION tracked_changes_tpdm.studentpath_deleted()
    RETURNS trigger AS
$BODY$
DECLARE
    dj0 edfi.student%ROWTYPE;
BEGIN
    ...
    INSERT INTO tracked_changes_tpdm.studentpath(
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'studentpath') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.studentpath 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.studentpath_deleted();
END IF;

CREATE OR REPLACE FUNCTION tracked_changes_tpdm.studentpathmilestonestatus_deleted()
    RETURNS trigger AS
$BODY$
DECLARE
    dj0 edfi.descriptor%ROWTYPE;
...
BEGIN
    ...
    INSERT INTO tracked_changes_tpdm.studentpathmilestonestatus(
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'studentpathmilestonestatus') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.studentpathmilestonestatus 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.studentpathmilestonestatus_deleted();
END IF;

CREATE OR REPLACE FUNCTION tracked_changes_tpdm.studentpathphasestatus_deleted()
    RETURNS trigger AS
$BODY$
DECLARE
    dj0 edfi.student%ROWTYPE;
BEGIN
    ...
    INSERT INTO tracked_changes_tpdm.studentpathphasestatus(
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'tpdm' AND event_object_table = 'studentpathphasestatus') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON tpdm.studentpathphasestatus 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_tpdm.studentpathphasestatus_deleted();
END IF;
