...
COMMENT ON COLUMN tpdm.StudentPathPeriod.BeginDate IS 'The month, day, and year for the start of the period.';
COMMENT ON COLUMN tpdm.StudentPathPeriod.EndDate IS 'The month, day, and year for the end of the period.';
...
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusPeriod.BeginDate IS 'The month, day, and year for the start of the period.';
COMMENT ON COLUMN tpdm.StudentPathPhaseStatusPeriod.EndDate IS 'The month, day, and year for the end of the period.';
