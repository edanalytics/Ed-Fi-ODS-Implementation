...
ALTER TABLE tpdm.ApplicantProfileAddressPeriod ADD CONSTRAINT FK_83971f_ApplicantProfileAddress FOREIGN KEY (ApplicantProfileIdentifier, AddressTypeDescriptorId, City, PostalCode, StateAbbreviationDescriptorId, StreetNumberName)
...
ALTER TABLE tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_fc4f14 ADD CONSTRAINT FK_fc4f14_CandidateEducatorPreparationProgramAssociationCandidateI_0d7c2b FOREIGN KEY (BeginDate, CandidateIdentifier, EducationOrganizationId, ProgramName, ProgramTypeDescriptorId, IndicatorName)
REFERENCES tpdm.CandidateEducatorPreparationProgramAssociationCandidateI_0d7c2b (BeginDate, CandidateIdentifier, EducationOrganizationId, ProgramName, ProgramTypeDescriptorId, IndicatorName)
ON DELETE CASCADE
;
...
ALTER TABLE tpdm.CandidateIndicatorPeriod ADD CONSTRAINT FK_9fac2f_CandidateIndicator FOREIGN KEY (CandidateIdentifier, BeginDate, IndicatorName)
...
ALTER TABLE tpdm.CertificationExamResult ADD CONSTRAINT FK_aed83e_StudentAssessment FOREIGN KEY (CertificationExamAssessmentIdentifier, CertificationExamNamespace, CertificationExamStudentAssessmentIdentifier, CertificationExamStudentUSI)
REFERENCES edfi.StudentAssessment (AssessmentIdentifier, Namespace, StudentAssessmentIdentifier, StudentUSI)
;

CREATE INDEX FK_aed83e_StudentAssessment
...
ALTER TABLE tpdm.OldEthnicityDescriptor ADD CONSTRAINT FK_821652_Descriptor FOREIGN KEY (OldEthnicityDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
...
ALTER TABLE tpdm.Path ADD CONSTRAINT FK_62fa5a_EducationOrganization FOREIGN KEY (EducationOrganizationId)
REFERENCES edfi.EducationOrganization (EducationOrganizationId)
;

ALTER TABLE tpdm.Path ADD CONSTRAINT FK_62fa5a_GraduationPlan FOREIGN KEY (EducationOrganizationId, GraduationPlanTypeDescriptorId, GraduationSchoolYear)
REFERENCES edfi.GraduationPlan (EducationOrganizationId, GraduationPlanTypeDescriptorId, GraduationSchoolYear)
;

CREATE INDEX FK_62fa5a_GraduationPlan
ON tpdm.Path (EducationOrganizationId ASC, GraduationPlanTypeDescriptorId ASC, GraduationSchoolYear ASC);

ALTER TABLE tpdm.PathMilestone ADD CONSTRAINT FK_63a11e_PathMilestoneTypeDescriptor FOREIGN KEY (PathMilestoneTypeDescriptorId)
REFERENCES tpdm.PathMilestoneTypeDescriptor (PathMilestoneTypeDescriptorId)
;

CREATE INDEX FK_63a11e_PathMilestoneTypeDescriptor
ON tpdm.PathMilestone (PathMilestoneTypeDescriptorId ASC);

ALTER TABLE tpdm.PathMilestoneStatusDescriptor ADD CONSTRAINT FK_c2f262_Descriptor FOREIGN KEY (PathMilestoneStatusDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;

ALTER TABLE tpdm.PathMilestoneTypeDescriptor ADD CONSTRAINT FK_cbe730_Descriptor FOREIGN KEY (PathMilestoneTypeDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;

ALTER TABLE tpdm.PathPhase ADD CONSTRAINT FK_94a0ce_Path FOREIGN KEY (EducationOrganizationId, PathName)
REFERENCES tpdm.Path (EducationOrganizationId, PathName)
;

CREATE INDEX FK_94a0ce_Path
ON tpdm.PathPhase (EducationOrganizationId ASC, PathName ASC);

ALTER TABLE tpdm.PathPhasePathMilestone ADD CONSTRAINT FK_431846_PathMilestone FOREIGN KEY (PathMilestoneName, PathMilestoneTypeDescriptorId)
REFERENCES tpdm.PathMilestone (PathMilestoneName, PathMilestoneTypeDescriptorId)
;

CREATE INDEX FK_431846_PathMilestone
ON tpdm.PathPhasePathMilestone (PathMilestoneName ASC, PathMilestoneTypeDescriptorId ASC);

ALTER TABLE tpdm.PathPhasePathMilestone ADD CONSTRAINT FK_431846_PathPhase FOREIGN KEY (EducationOrganizationId, PathName, PathPhaseName)
REFERENCES tpdm.PathPhase (EducationOrganizationId, PathName, PathPhaseName)
ON DELETE CASCADE
;

ALTER TABLE tpdm.PathPhaseStatusDescriptor ADD CONSTRAINT FK_02badd_Descriptor FOREIGN KEY (PathPhaseStatusDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
...
ALTER TABLE tpdm.RecruitmentEventAttendanceDisabilityDesignation ADD CONSTRAINT FK_144c1f_RecruitmentEventAttendanceDisability FOREIGN KEY (EducationOrganizationId, EventDate, EventTitle, RecruitmentEventAttendeeIdentifier, DisabilityDescriptorId)
...
ALTER TABLE tpdm.StudentGradebookEntryExtension ADD CONSTRAINT FK_c1d2f5_StudentGradebookEntry FOREIGN KEY (GradebookEntryIdentifier, Namespace, StudentUSI)
REFERENCES edfi.StudentGradebookEntry (GradebookEntryIdentifier, Namespace, StudentUSI)
ON DELETE CASCADE
ON UPDATE CASCADE
;

ALTER TABLE tpdm.StudentPath ADD CONSTRAINT FK_efd39c_Path FOREIGN KEY (EducationOrganizationId, PathName)
REFERENCES tpdm.Path (EducationOrganizationId, PathName)
;

CREATE INDEX FK_efd39c_Path
ON tpdm.StudentPath (EducationOrganizationId ASC, PathName ASC);

ALTER TABLE tpdm.StudentPath ADD CONSTRAINT FK_efd39c_Student FOREIGN KEY (StudentUSI)
REFERENCES edfi.Student (StudentUSI)
;

CREATE INDEX FK_efd39c_Student
ON tpdm.StudentPath (StudentUSI ASC);

ALTER TABLE tpdm.StudentPathMilestoneStatus ADD CONSTRAINT FK_bffe71_PathMilestone FOREIGN KEY (PathMilestoneName, PathMilestoneTypeDescriptorId)
REFERENCES tpdm.PathMilestone (PathMilestoneName, PathMilestoneTypeDescriptorId)
;

CREATE INDEX FK_bffe71_PathMilestone
ON tpdm.StudentPathMilestoneStatus (PathMilestoneName ASC, PathMilestoneTypeDescriptorId ASC);

ALTER TABLE tpdm.StudentPathMilestoneStatus ADD CONSTRAINT FK_bffe71_PathPhase FOREIGN KEY (EducationOrganizationId, PathName, PathPhaseName)
REFERENCES tpdm.PathPhase (EducationOrganizationId, PathName, PathPhaseName)
;

CREATE INDEX FK_bffe71_PathPhase
ON tpdm.StudentPathMilestoneStatus (EducationOrganizationId ASC, PathName ASC, PathPhaseName ASC);

ALTER TABLE tpdm.StudentPathMilestoneStatus ADD CONSTRAINT FK_bffe71_StudentPath FOREIGN KEY (EducationOrganizationId, PathName, StudentUSI)
REFERENCES tpdm.StudentPath (EducationOrganizationId, PathName, StudentUSI)
;

CREATE INDEX FK_bffe71_StudentPath
ON tpdm.StudentPathMilestoneStatus (EducationOrganizationId ASC, PathName ASC, StudentUSI ASC);

ALTER TABLE tpdm.StudentPathMilestoneStatusEvent ADD CONSTRAINT FK_5e58a1_PathMilestoneStatusDescriptor FOREIGN KEY (PathMilestoneStatusDescriptorId)
REFERENCES tpdm.PathMilestoneStatusDescriptor (PathMilestoneStatusDescriptorId)
;

CREATE INDEX FK_5e58a1_PathMilestoneStatusDescriptor
ON tpdm.StudentPathMilestoneStatusEvent (PathMilestoneStatusDescriptorId ASC);

ALTER TABLE tpdm.StudentPathMilestoneStatusEvent ADD CONSTRAINT FK_5e58a1_StudentPathMilestoneStatus FOREIGN KEY (EducationOrganizationId, PathMilestoneName, PathMilestoneTypeDescriptorId, PathName, StudentUSI)
...
ALTER TABLE tpdm.StudentPathPeriod ADD CONSTRAINT FK_5b1914_StudentPath FOREIGN KEY (EducationOrganizationId, PathName, StudentUSI)
REFERENCES tpdm.StudentPath (EducationOrganizationId, PathName, StudentUSI)
ON DELETE CASCADE
;

ALTER TABLE tpdm.StudentPathPhaseStatus ADD CONSTRAINT FK_a174cf_PathPhase FOREIGN KEY (EducationOrganizationId, PathName, PathPhaseName)
REFERENCES tpdm.PathPhase (EducationOrganizationId, PathName, PathPhaseName)
;

CREATE INDEX FK_a174cf_PathPhase
ON tpdm.StudentPathPhaseStatus (EducationOrganizationId ASC, PathName ASC, PathPhaseName ASC);

ALTER TABLE tpdm.StudentPathPhaseStatus ADD CONSTRAINT FK_a174cf_StudentPath FOREIGN KEY (EducationOrganizationId, PathName, StudentUSI)
REFERENCES tpdm.StudentPath (EducationOrganizationId, PathName, StudentUSI)
;

CREATE INDEX FK_a174cf_StudentPath
ON tpdm.StudentPathPhaseStatus (EducationOrganizationId ASC, PathName ASC, StudentUSI ASC);

ALTER TABLE tpdm.StudentPathPhaseStatusEvent ADD CONSTRAINT FK_29f3eb_PathPhaseStatusDescriptor FOREIGN KEY (PathPhaseStatusDescriptorId)
REFERENCES tpdm.PathPhaseStatusDescriptor (PathPhaseStatusDescriptorId)
;

CREATE INDEX FK_29f3eb_PathPhaseStatusDescriptor
ON tpdm.StudentPathPhaseStatusEvent (PathPhaseStatusDescriptorId ASC);

ALTER TABLE tpdm.StudentPathPhaseStatusEvent ADD CONSTRAINT FK_29f3eb_StudentPathPhaseStatus FOREIGN KEY (EducationOrganizationId, PathName, PathPhaseName, StudentUSI)
REFERENCES tpdm.StudentPathPhaseStatus (EducationOrganizationId, PathName, PathPhaseName, StudentUSI)
ON DELETE CASCADE
;

ALTER TABLE tpdm.StudentPathPhaseStatusPeriod ADD CONSTRAINT FK_6c828a_StudentPathPhaseStatus FOREIGN KEY (EducationOrganizationId, PathName, PathPhaseName, StudentUSI)
REFERENCES tpdm.StudentPathPhaseStatus (EducationOrganizationId, PathName, PathPhaseName, StudentUSI)
ON DELETE CASCADE
;
