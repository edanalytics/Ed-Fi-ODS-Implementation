...
DROP TRIGGER IF EXISTS [tpdm].[tpdm_OldEthnicityDescriptor_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_OldEthnicityDescriptor_TR_DeleteTracking] ON [tpdm].[OldEthnicityDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_edfi].[Descriptor](OldDescriptorId, OldCodeValue, OldNamespace, Id, Discriminator, ChangeVersion)
    SELECT  d.OldEthnicityDescriptorId, b.CodeValue, b.Namespace, b.Id, 'tpdm.OldEthnicityDescriptor', (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
            INNER JOIN edfi.Descriptor b ON d.OldEthnicityDescriptorId = b.DescriptorId
END
GO

ALTER TABLE [tpdm].[OldEthnicityDescriptor] ENABLE TRIGGER [tpdm_OldEthnicityDescriptor_TR_DeleteTracking]
GO
...
DROP TRIGGER IF EXISTS [tpdm].[tpdm_Path_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_Path_TR_DeleteTracking] ON [tpdm].[Path] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_tpdm].[Path](OldEducationOrganizationId, OldPathName, Id, Discriminator, ChangeVersion)
    SELECT d.EducationOrganizationId, d.PathName, d.Id, d.Discriminator, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
END
GO

ALTER TABLE [tpdm].[Path] ENABLE TRIGGER [tpdm_Path_TR_DeleteTracking]
GO


DROP TRIGGER IF EXISTS [tpdm].[tpdm_PathMilestone_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_PathMilestone_TR_DeleteTracking] ON [tpdm].[PathMilestone] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_tpdm].[PathMilestone](OldPathMilestoneName, OldPathMilestoneTypeDescriptorId, OldPathMilestoneTypeDescriptorNamespace, OldPathMilestoneTypeDescriptorCodeValue, Id, Discriminator, ChangeVersion)
    SELECT d.PathMilestoneName, d.PathMilestoneTypeDescriptorId, j0.Namespace, j0.CodeValue, d.Id, d.Discriminator, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
        INNER JOIN edfi.Descriptor j0
            ON d.PathMilestoneTypeDescriptorId = j0.DescriptorId
END
GO

ALTER TABLE [tpdm].[PathMilestone] ENABLE TRIGGER [tpdm_PathMilestone_TR_DeleteTracking]
GO


DROP TRIGGER IF EXISTS [tpdm].[tpdm_PathMilestoneStatusDescriptor_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_PathMilestoneStatusDescriptor_TR_DeleteTracking] ON [tpdm].[PathMilestoneStatusDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_edfi].[Descriptor](OldDescriptorId, OldCodeValue, OldNamespace, Id, Discriminator, ChangeVersion)
    SELECT  d.PathMilestoneStatusDescriptorId, b.CodeValue, b.Namespace, b.Id, 'tpdm.PathMilestoneStatusDescriptor', (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
            INNER JOIN edfi.Descriptor b ON d.PathMilestoneStatusDescriptorId = b.DescriptorId
END
GO

ALTER TABLE [tpdm].[PathMilestoneStatusDescriptor] ENABLE TRIGGER [tpdm_PathMilestoneStatusDescriptor_TR_DeleteTracking]
GO


DROP TRIGGER IF EXISTS [tpdm].[tpdm_PathMilestoneTypeDescriptor_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_PathMilestoneTypeDescriptor_TR_DeleteTracking] ON [tpdm].[PathMilestoneTypeDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_edfi].[Descriptor](OldDescriptorId, OldCodeValue, OldNamespace, Id, Discriminator, ChangeVersion)
    SELECT  d.PathMilestoneTypeDescriptorId, b.CodeValue, b.Namespace, b.Id, 'tpdm.PathMilestoneTypeDescriptor', (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
            INNER JOIN edfi.Descriptor b ON d.PathMilestoneTypeDescriptorId = b.DescriptorId
END
GO

ALTER TABLE [tpdm].[PathMilestoneTypeDescriptor] ENABLE TRIGGER [tpdm_PathMilestoneTypeDescriptor_TR_DeleteTracking]
GO


DROP TRIGGER IF EXISTS [tpdm].[tpdm_PathPhase_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_PathPhase_TR_DeleteTracking] ON [tpdm].[PathPhase] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_tpdm].[PathPhase](OldEducationOrganizationId, OldPathName, OldPathPhaseName, Id, Discriminator, ChangeVersion)
    SELECT d.EducationOrganizationId, d.PathName, d.PathPhaseName, d.Id, d.Discriminator, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
END
GO

ALTER TABLE [tpdm].[PathPhase] ENABLE TRIGGER [tpdm_PathPhase_TR_DeleteTracking]
GO


DROP TRIGGER IF EXISTS [tpdm].[tpdm_PathPhaseStatusDescriptor_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_PathPhaseStatusDescriptor_TR_DeleteTracking] ON [tpdm].[PathPhaseStatusDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_edfi].[Descriptor](OldDescriptorId, OldCodeValue, OldNamespace, Id, Discriminator, ChangeVersion)
    SELECT  d.PathPhaseStatusDescriptorId, b.CodeValue, b.Namespace, b.Id, 'tpdm.PathPhaseStatusDescriptor', (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
            INNER JOIN edfi.Descriptor b ON d.PathPhaseStatusDescriptorId = b.DescriptorId
END
GO

ALTER TABLE [tpdm].[PathPhaseStatusDescriptor] ENABLE TRIGGER [tpdm_PathPhaseStatusDescriptor_TR_DeleteTracking]
GO
...
DROP TRIGGER IF EXISTS [tpdm].[tpdm_StudentPath_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_StudentPath_TR_DeleteTracking] ON [tpdm].[StudentPath] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_tpdm].[StudentPath](OldEducationOrganizationId, OldPathName, OldStudentUSI, OldStudentUniqueId, Id, Discriminator, ChangeVersion)
    SELECT d.EducationOrganizationId, d.PathName, d.StudentUSI, j0.StudentUniqueId, d.Id, d.Discriminator, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
        INNER JOIN edfi.Student j0
            ON d.StudentUSI = j0.StudentUSI
END
...
ALTER TABLE [tpdm].[StudentPath] ENABLE TRIGGER [tpdm_StudentPath_TR_DeleteTracking]
GO


DROP TRIGGER IF EXISTS [tpdm].[tpdm_StudentPathMilestoneStatus_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_StudentPathMilestoneStatus_TR_DeleteTracking] ON [tpdm].[StudentPathMilestoneStatus] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_tpdm].[StudentPathMilestoneStatus](OldEducationOrganizationId, OldPathMilestoneName, OldPathMilestoneTypeDescriptorId, OldPathMilestoneTypeDescriptorNamespace, OldPathMilestoneTypeDescriptorCodeValue, OldPathName, OldStudentUSI, OldStudentUniqueId, Id, Discriminator, ChangeVersion)
    SELECT d.EducationOrganizationId, d.PathMilestoneName, d.PathMilestoneTypeDescriptorId, j0.Namespace, j0.CodeValue, d.PathName, d.StudentUSI, j1.StudentUniqueId, d.Id, d.Discriminator, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
        INNER JOIN edfi.Descriptor j0
            ON d.PathMilestoneTypeDescriptorId = j0.DescriptorId
        INNER JOIN edfi.Student j1
...
ALTER TABLE [tpdm].[StudentPathMilestoneStatus] ENABLE TRIGGER [tpdm_StudentPathMilestoneStatus_TR_DeleteTracking]
GO


DROP TRIGGER IF EXISTS [tpdm].[tpdm_StudentPathPhaseStatus_TR_DeleteTracking]
GO

CREATE TRIGGER [tpdm].[tpdm_StudentPathPhaseStatus_TR_DeleteTracking] ON [tpdm].[StudentPathPhaseStatus] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
    ...
    INSERT INTO [tracked_changes_tpdm].[StudentPathPhaseStatus](OldEducationOrganizationId, OldPathName, OldPathPhaseName, OldStudentUSI, OldStudentUniqueId, Id, Discriminator, ChangeVersion)
    SELECT d.EducationOrganizationId, d.PathName, d.PathPhaseName, d.StudentUSI, j0.StudentUniqueId, d.Id, d.Discriminator, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
        INNER JOIN edfi.Student j0
            ON d.StudentUSI = j0.StudentUSI
END
...
ALTER TABLE [tpdm].[StudentPathPhaseStatus] ENABLE TRIGGER [tpdm_StudentPathPhaseStatus_TR_DeleteTracking]
GO
