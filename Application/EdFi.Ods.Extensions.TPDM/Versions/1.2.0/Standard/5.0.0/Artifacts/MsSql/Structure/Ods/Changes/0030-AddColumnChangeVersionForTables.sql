...
IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[tpdm].[Path]') AND name = 'ChangeVersion')
BEGIN
ALTER TABLE [tpdm].[Path] ADD [ChangeVersion] [BIGINT] CONSTRAINT Path_DF_ChangeVersion DEFAULT (0) NOT NULL;
ALTER TABLE [tpdm].[Path] DROP CONSTRAINT Path_DF_ChangeVersion;
ALTER TABLE [tpdm].[Path] ADD CONSTRAINT Path_DF_ChangeVersion DEFAULT (NEXT VALUE FOR [changes].[ChangeVersionSequence]) For [ChangeVersion];
END


IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[tpdm].[PathMilestone]') AND name = 'ChangeVersion')
BEGIN
ALTER TABLE [tpdm].[PathMilestone] ADD [ChangeVersion] [BIGINT] CONSTRAINT PathMilestone_DF_ChangeVersion DEFAULT (0) NOT NULL;
ALTER TABLE [tpdm].[PathMilestone] DROP CONSTRAINT PathMilestone_DF_ChangeVersion;
ALTER TABLE [tpdm].[PathMilestone] ADD CONSTRAINT PathMilestone_DF_ChangeVersion DEFAULT (NEXT VALUE FOR [changes].[ChangeVersionSequence]) For [ChangeVersion];
END


IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[tpdm].[PathPhase]') AND name = 'ChangeVersion')
BEGIN
ALTER TABLE [tpdm].[PathPhase] ADD [ChangeVersion] [BIGINT] CONSTRAINT PathPhase_DF_ChangeVersion DEFAULT (0) NOT NULL;
ALTER TABLE [tpdm].[PathPhase] DROP CONSTRAINT PathPhase_DF_ChangeVersion;
ALTER TABLE [tpdm].[PathPhase] ADD CONSTRAINT PathPhase_DF_ChangeVersion DEFAULT (NEXT VALUE FOR [changes].[ChangeVersionSequence]) For [ChangeVersion];
END
...
IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[tpdm].[StudentPath]') AND name = 'ChangeVersion')
BEGIN
ALTER TABLE [tpdm].[StudentPath] ADD [ChangeVersion] [BIGINT] CONSTRAINT StudentPath_DF_ChangeVersion DEFAULT (0) NOT NULL;
ALTER TABLE [tpdm].[StudentPath] DROP CONSTRAINT StudentPath_DF_ChangeVersion;
ALTER TABLE [tpdm].[StudentPath] ADD CONSTRAINT StudentPath_DF_ChangeVersion DEFAULT (NEXT VALUE FOR [changes].[ChangeVersionSequence]) For [ChangeVersion];
END


IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[tpdm].[StudentPathMilestoneStatus]') AND name = 'ChangeVersion')
BEGIN
ALTER TABLE [tpdm].[StudentPathMilestoneStatus] ADD [ChangeVersion] [BIGINT] CONSTRAINT StudentPathMilestoneStatus_DF_ChangeVersion DEFAULT (0) NOT NULL;
ALTER TABLE [tpdm].[StudentPathMilestoneStatus] DROP CONSTRAINT StudentPathMilestoneStatus_DF_ChangeVersion;
ALTER TABLE [tpdm].[StudentPathMilestoneStatus] ADD CONSTRAINT StudentPathMilestoneStatus_DF_ChangeVersion DEFAULT (NEXT VALUE FOR [changes].[ChangeVersionSequence]) For [ChangeVersion];
END


IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[tpdm].[StudentPathPhaseStatus]') AND name = 'ChangeVersion')
BEGIN
ALTER TABLE [tpdm].[StudentPathPhaseStatus] ADD [ChangeVersion] [BIGINT] CONSTRAINT StudentPathPhaseStatus_DF_ChangeVersion DEFAULT (0) NOT NULL;
ALTER TABLE [tpdm].[StudentPathPhaseStatus] DROP CONSTRAINT StudentPathPhaseStatus_DF_ChangeVersion;
ALTER TABLE [tpdm].[StudentPathPhaseStatus] ADD CONSTRAINT StudentPathPhaseStatus_DF_ChangeVersion DEFAULT (NEXT VALUE FOR [changes].[ChangeVersionSequence]) For [ChangeVersion];
END
