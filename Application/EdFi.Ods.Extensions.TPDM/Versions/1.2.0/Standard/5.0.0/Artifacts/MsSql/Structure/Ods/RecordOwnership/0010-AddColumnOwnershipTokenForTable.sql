...
ALTER TABLE [tpdm].[Path] ADD [CreatedByOwnershipTokenId] SMALLINT NULL;

ALTER TABLE [tpdm].[PathMilestone] ADD [CreatedByOwnershipTokenId] SMALLINT NULL;

ALTER TABLE [tpdm].[PathPhase] ADD [CreatedByOwnershipTokenId] SMALLINT NULL;
...
ALTER TABLE [tpdm].[StudentPath] ADD [CreatedByOwnershipTokenId] SMALLINT NULL;

ALTER TABLE [tpdm].[StudentPathMilestoneStatus] ADD [CreatedByOwnershipTokenId] SMALLINT NULL;

ALTER TABLE [tpdm].[StudentPathPhaseStatus] ADD [CreatedByOwnershipTokenId] SMALLINT NULL;
