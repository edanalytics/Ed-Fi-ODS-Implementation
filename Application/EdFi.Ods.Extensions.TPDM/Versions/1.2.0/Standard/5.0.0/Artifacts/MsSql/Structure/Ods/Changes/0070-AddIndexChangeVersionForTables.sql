...
BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.Path') AND name = N'UX_Path_ChangeVersion')
    CREATE INDEX [UX_Path_ChangeVersion] ON [tpdm].[Path] ([ChangeVersion] ASC)
    GO
COMMIT

BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.PathMilestone') AND name = N'UX_PathMilestone_ChangeVersion')
    CREATE INDEX [UX_PathMilestone_ChangeVersion] ON [tpdm].[PathMilestone] ([ChangeVersion] ASC)
    GO
COMMIT

BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.PathPhase') AND name = N'UX_PathPhase_ChangeVersion')
    CREATE INDEX [UX_PathPhase_ChangeVersion] ON [tpdm].[PathPhase] ([ChangeVersion] ASC)
    GO
COMMIT
...
BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.StudentPath') AND name = N'UX_StudentPath_ChangeVersion')
    CREATE INDEX [UX_StudentPath_ChangeVersion] ON [tpdm].[StudentPath] ([ChangeVersion] ASC)
    GO
COMMIT

BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.StudentPathMilestoneStatus') AND name = N'UX_StudentPathMilestoneStatus_ChangeVersion')
    CREATE INDEX [UX_StudentPathMilestoneStatus_ChangeVersion] ON [tpdm].[StudentPathMilestoneStatus] ([ChangeVersion] ASC)
    GO
COMMIT

BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'tpdm.StudentPathPhaseStatus') AND name = N'UX_StudentPathPhaseStatus_ChangeVersion')
    CREATE INDEX [UX_StudentPathPhaseStatus_ChangeVersion] ON [tpdm].[StudentPathPhaseStatus] ([ChangeVersion] ASC)
    GO
COMMIT
