...
ALTER TABLE [tpdm].[ApplicantProfileAddressPeriod] WITH CHECK ADD CONSTRAINT [FK_ApplicantProfileAddressPeriod_ApplicantProfileAddress] FOREIGN KEY ([ApplicantProfileIdentifier], [AddressTypeDescriptorId], [City], [PostalCode], [StateAbbreviationDescriptorId], [StreetNumberName])
REFERENCES [tpdm].[ApplicantProfileAddress] ([ApplicantProfileIdentifier], [AddressTypeDescriptorId], [City], [PostalCode], [StateAbbreviationDescriptorId], [StreetNumberName])
ON DELETE CASCADE
GO
...
REFERENCES [tpdm].[OldEthnicityDescriptor] ([OldEthnicityDescriptorId])
GO
...
ALTER TABLE [tpdm].[CandidateEducatorPreparationProgramAssociationCandidateIndicatorPeriod] WITH CHECK ADD CONSTRAINT [FK_CandidateEducatorPreparationProgramAssociationCandidateIndicatorPeriod_CandidateEducatorPreparationProgramAssociationCandidat] FOREIGN KEY ([BeginDate], [CandidateIdentifier], [EducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId], [IndicatorName])
REFERENCES [tpdm].[CandidateEducatorPreparationProgramAssociationCandidateIndicator] ([BeginDate], [CandidateIdentifier], [EducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId], [IndicatorName])
ON DELETE CASCADE
GO
...
ALTER TABLE [tpdm].[CandidateIndicatorPeriod] WITH CHECK ADD CONSTRAINT [FK_CandidateIndicatorPeriod_CandidateIndicator] FOREIGN KEY ([CandidateIdentifier], [BeginDate], [IndicatorName])
REFERENCES [tpdm].[CandidateIndicator] ([CandidateIdentifier], [BeginDate], [IndicatorName])
ON DELETE CASCADE
GO
...
ALTER TABLE [tpdm].[CertificationExamResult] WITH CHECK ADD CONSTRAINT [FK_CertificationExamResult_StudentAssessment] FOREIGN KEY ([CertificationExamAssessmentIdentifier], [CertificationExamNamespace], [CertificationExamStudentAssessmentIdentifier], [CertificationExamStudentUSI])
...
ON [tpdm].[CertificationExamResult] ([CertificationExamAssessmentIdentifier] ASC, [CertificationExamNamespace] ASC, [CertificationExamStudentAssessmentIdentifier] ASC, [CertificationExamStudentUSI] ASC)
GO
...
ALTER TABLE [tpdm].[OldEthnicityDescriptor] WITH CHECK ADD CONSTRAINT [FK_OldEthnicityDescriptor_Descriptor] FOREIGN KEY ([OldEthnicityDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [tpdm].[Path] WITH CHECK ADD CONSTRAINT [FK_Path_EducationOrganization] FOREIGN KEY ([EducationOrganizationId])
REFERENCES [edfi].[EducationOrganization] ([EducationOrganizationId])
GO

ALTER TABLE [tpdm].[Path] WITH CHECK ADD CONSTRAINT [FK_Path_GraduationPlan] FOREIGN KEY ([EducationOrganizationId], [GraduationPlanTypeDescriptorId], [GraduationSchoolYear])
REFERENCES [edfi].[GraduationPlan] ([EducationOrganizationId], [GraduationPlanTypeDescriptorId], [GraduationSchoolYear])
GO

CREATE NONCLUSTERED INDEX [FK_Path_GraduationPlan]
ON [tpdm].[Path] ([EducationOrganizationId] ASC, [GraduationPlanTypeDescriptorId] ASC, [GraduationSchoolYear] ASC)
GO

ALTER TABLE [tpdm].[PathMilestone] WITH CHECK ADD CONSTRAINT [FK_PathMilestone_PathMilestoneTypeDescriptor] FOREIGN KEY ([PathMilestoneTypeDescriptorId])
REFERENCES [tpdm].[PathMilestoneTypeDescriptor] ([PathMilestoneTypeDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_PathMilestone_PathMilestoneTypeDescriptor]
ON [tpdm].[PathMilestone] ([PathMilestoneTypeDescriptorId] ASC)
GO

ALTER TABLE [tpdm].[PathMilestoneStatusDescriptor] WITH CHECK ADD CONSTRAINT [FK_PathMilestoneStatusDescriptor_Descriptor] FOREIGN KEY ([PathMilestoneStatusDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO

ALTER TABLE [tpdm].[PathMilestoneTypeDescriptor] WITH CHECK ADD CONSTRAINT [FK_PathMilestoneTypeDescriptor_Descriptor] FOREIGN KEY ([PathMilestoneTypeDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO

ALTER TABLE [tpdm].[PathPhase] WITH CHECK ADD CONSTRAINT [FK_PathPhase_Path] FOREIGN KEY ([EducationOrganizationId], [PathName])
REFERENCES [tpdm].[Path] ([EducationOrganizationId], [PathName])
GO

CREATE NONCLUSTERED INDEX [FK_PathPhase_Path]
ON [tpdm].[PathPhase] ([EducationOrganizationId] ASC, [PathName] ASC)
GO

ALTER TABLE [tpdm].[PathPhasePathMilestone] WITH CHECK ADD CONSTRAINT [FK_PathPhasePathMilestone_PathMilestone] FOREIGN KEY ([PathMilestoneName], [PathMilestoneTypeDescriptorId])
REFERENCES [tpdm].[PathMilestone] ([PathMilestoneName], [PathMilestoneTypeDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_PathPhasePathMilestone_PathMilestone]
ON [tpdm].[PathPhasePathMilestone] ([PathMilestoneName] ASC, [PathMilestoneTypeDescriptorId] ASC)
GO

ALTER TABLE [tpdm].[PathPhasePathMilestone] WITH CHECK ADD CONSTRAINT [FK_PathPhasePathMilestone_PathPhase] FOREIGN KEY ([EducationOrganizationId], [PathName], [PathPhaseName])
REFERENCES [tpdm].[PathPhase] ([EducationOrganizationId], [PathName], [PathPhaseName])
ON DELETE CASCADE
GO

ALTER TABLE [tpdm].[PathPhaseStatusDescriptor] WITH CHECK ADD CONSTRAINT [FK_PathPhaseStatusDescriptor_Descriptor] FOREIGN KEY ([PathPhaseStatusDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [tpdm].[RecruitmentEventAttendanceDisabilityDesignation] WITH CHECK ADD CONSTRAINT [FK_RecruitmentEventAttendanceDisabilityDesignation_RecruitmentEventAttendanceDisability] FOREIGN KEY ([EducationOrganizationId], [EventDate], [EventTitle], [RecruitmentEventAttendeeIdentifier], [DisabilityDescriptorId])
REFERENCES [tpdm].[RecruitmentEventAttendanceDisability] ([EducationOrganizationId], [EventDate], [EventTitle], [RecruitmentEventAttendeeIdentifier], [DisabilityDescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [tpdm].[StudentGradebookEntryExtension] WITH CHECK ADD CONSTRAINT [FK_StudentGradebookEntryExtension_StudentGradebookEntry] FOREIGN KEY ([GradebookEntryIdentifier], [Namespace], [StudentUSI])
REFERENCES [edfi].[StudentGradebookEntry] ([GradebookEntryIdentifier], [Namespace], [StudentUSI])
ON DELETE CASCADE
ON UPDATE CASCADE
GO

ALTER TABLE [tpdm].[StudentPath] WITH CHECK ADD CONSTRAINT [FK_StudentPath_Path] FOREIGN KEY ([EducationOrganizationId], [PathName])
REFERENCES [tpdm].[Path] ([EducationOrganizationId], [PathName])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPath_Path]
ON [tpdm].[StudentPath] ([EducationOrganizationId] ASC, [PathName] ASC)
GO

ALTER TABLE [tpdm].[StudentPath] WITH CHECK ADD CONSTRAINT [FK_StudentPath_Student] FOREIGN KEY ([StudentUSI])
REFERENCES [edfi].[Student] ([StudentUSI])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPath_Student]
ON [tpdm].[StudentPath] ([StudentUSI] ASC)
GO

ALTER TABLE [tpdm].[StudentPathMilestoneStatus] WITH CHECK ADD CONSTRAINT [FK_StudentPathMilestoneStatus_PathMilestone] FOREIGN KEY ([PathMilestoneName], [PathMilestoneTypeDescriptorId])
REFERENCES [tpdm].[PathMilestone] ([PathMilestoneName], [PathMilestoneTypeDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPathMilestoneStatus_PathMilestone]
ON [tpdm].[StudentPathMilestoneStatus] ([PathMilestoneName] ASC, [PathMilestoneTypeDescriptorId] ASC)
GO

ALTER TABLE [tpdm].[StudentPathMilestoneStatus] WITH CHECK ADD CONSTRAINT [FK_StudentPathMilestoneStatus_PathPhase] FOREIGN KEY ([EducationOrganizationId], [PathName], [PathPhaseName])
REFERENCES [tpdm].[PathPhase] ([EducationOrganizationId], [PathName], [PathPhaseName])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPathMilestoneStatus_PathPhase]
ON [tpdm].[StudentPathMilestoneStatus] ([EducationOrganizationId] ASC, [PathName] ASC, [PathPhaseName] ASC)
GO

ALTER TABLE [tpdm].[StudentPathMilestoneStatus] WITH CHECK ADD CONSTRAINT [FK_StudentPathMilestoneStatus_StudentPath] FOREIGN KEY ([EducationOrganizationId], [PathName], [StudentUSI])
REFERENCES [tpdm].[StudentPath] ([EducationOrganizationId], [PathName], [StudentUSI])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPathMilestoneStatus_StudentPath]
ON [tpdm].[StudentPathMilestoneStatus] ([EducationOrganizationId] ASC, [PathName] ASC, [StudentUSI] ASC)
GO

ALTER TABLE [tpdm].[StudentPathMilestoneStatusEvent] WITH CHECK ADD CONSTRAINT [FK_StudentPathMilestoneStatusEvent_PathMilestoneStatusDescriptor] FOREIGN KEY ([PathMilestoneStatusDescriptorId])
REFERENCES [tpdm].[PathMilestoneStatusDescriptor] ([PathMilestoneStatusDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPathMilestoneStatusEvent_PathMilestoneStatusDescriptor]
ON [tpdm].[StudentPathMilestoneStatusEvent] ([PathMilestoneStatusDescriptorId] ASC)
GO

ALTER TABLE [tpdm].[StudentPathMilestoneStatusEvent] WITH CHECK ADD CONSTRAINT [FK_StudentPathMilestoneStatusEvent_StudentPathMilestoneStatus] FOREIGN KEY ([EducationOrganizationId], [PathMilestoneName], [PathMilestoneTypeDescriptorId], [PathName], [StudentUSI])
REFERENCES [tpdm].[StudentPathMilestoneStatus] ([EducationOrganizationId], [PathMilestoneName], [PathMilestoneTypeDescriptorId], [PathName], [StudentUSI])
ON DELETE CASCADE
GO

ALTER TABLE [tpdm].[StudentPathPeriod] WITH CHECK ADD CONSTRAINT [FK_StudentPathPeriod_StudentPath] FOREIGN KEY ([EducationOrganizationId], [PathName], [StudentUSI])
REFERENCES [tpdm].[StudentPath] ([EducationOrganizationId], [PathName], [StudentUSI])
ON DELETE CASCADE
GO

ALTER TABLE [tpdm].[StudentPathPhaseStatus] WITH CHECK ADD CONSTRAINT [FK_StudentPathPhaseStatus_PathPhase] FOREIGN KEY ([EducationOrganizationId], [PathName], [PathPhaseName])
REFERENCES [tpdm].[PathPhase] ([EducationOrganizationId], [PathName], [PathPhaseName])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPathPhaseStatus_PathPhase]
ON [tpdm].[StudentPathPhaseStatus] ([EducationOrganizationId] ASC, [PathName] ASC, [PathPhaseName] ASC)
GO

ALTER TABLE [tpdm].[StudentPathPhaseStatus] WITH CHECK ADD CONSTRAINT [FK_StudentPathPhaseStatus_StudentPath] FOREIGN KEY ([EducationOrganizationId], [PathName], [StudentUSI])
REFERENCES [tpdm].[StudentPath] ([EducationOrganizationId], [PathName], [StudentUSI])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPathPhaseStatus_StudentPath]
ON [tpdm].[StudentPathPhaseStatus] ([EducationOrganizationId] ASC, [PathName] ASC, [StudentUSI] ASC)
GO

ALTER TABLE [tpdm].[StudentPathPhaseStatusEvent] WITH CHECK ADD CONSTRAINT [FK_StudentPathPhaseStatusEvent_PathPhaseStatusDescriptor] FOREIGN KEY ([PathPhaseStatusDescriptorId])
REFERENCES [tpdm].[PathPhaseStatusDescriptor] ([PathPhaseStatusDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentPathPhaseStatusEvent_PathPhaseStatusDescriptor]
ON [tpdm].[StudentPathPhaseStatusEvent] ([PathPhaseStatusDescriptorId] ASC)
GO

ALTER TABLE [tpdm].[StudentPathPhaseStatusEvent] WITH CHECK ADD CONSTRAINT [FK_StudentPathPhaseStatusEvent_StudentPathPhaseStatus] FOREIGN KEY ([EducationOrganizationId], [PathName], [PathPhaseName], [StudentUSI])
REFERENCES [tpdm].[StudentPathPhaseStatus] ([EducationOrganizationId], [PathName], [PathPhaseName], [StudentUSI])
ON DELETE CASCADE
GO

ALTER TABLE [tpdm].[StudentPathPhaseStatusPeriod] WITH CHECK ADD CONSTRAINT [FK_StudentPathPhaseStatusPeriod_StudentPathPhaseStatus] FOREIGN KEY ([EducationOrganizationId], [PathName], [PathPhaseName], [StudentUSI])
REFERENCES [tpdm].[StudentPathPhaseStatus] ([EducationOrganizationId], [PathName], [PathPhaseName], [StudentUSI])
ON DELETE CASCADE
GO
