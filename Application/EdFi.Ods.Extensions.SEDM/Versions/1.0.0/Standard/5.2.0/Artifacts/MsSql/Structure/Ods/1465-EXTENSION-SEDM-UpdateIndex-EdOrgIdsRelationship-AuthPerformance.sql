...
CREATE INDEX IX_StudentIEP_EducationOrganizationId ON [sedm].[StudentIEP](EducationOrganizationId) INCLUDE (AggregateId);
...
DROP INDEX IF EXISTS IX_StudentIEPAccommodationCollection_EducationOrganizationId ON [sedm].[StudentIEPAccommodationCollection];
CREATE INDEX IX_StudentIEPAccommodationCollection_EducationOrganizationId ON [sedm].[StudentIEPAccommodationCollection](EducationOrganizationId) INCLUDE (AggregateId);
...
DROP INDEX IF EXISTS IX_StudentIEPDisabilityCollection_EducationOrganizationId ON [sedm].[StudentIEPDisabilityCollection];
CREATE INDEX IX_StudentIEPDisabilityCollection_EducationOrganizationId ON [sedm].[StudentIEPDisabilityCollection](EducationOrganizationId) INCLUDE (AggregateId);
...
DROP INDEX IF EXISTS IX_StudentIEPGoal_EducationOrganizationId ON [sedm].[StudentIEPGoal];
CREATE INDEX IX_StudentIEPGoal_EducationOrganizationId ON [sedm].[StudentIEPGoal](EducationOrganizationId) INCLUDE (AggregateId);
...
DROP INDEX IF EXISTS IX_StudentIEPServiceDelivery_EducationOrganizationId ON [sedm].[StudentIEPServiceDelivery];
CREATE INDEX IX_StudentIEPServiceDelivery_EducationOrganizationId ON [sedm].[StudentIEPServiceDelivery](EducationOrganizationId) INCLUDE (AggregateId);
...
DROP INDEX IF EXISTS IX_StudentIEPServicePrescription_EducationOrganizationId ON [sedm].[StudentIEPServicePrescription];
CREATE INDEX IX_StudentIEPServicePrescription_EducationOrganizationId ON [sedm].[StudentIEPServicePrescription](EducationOrganizationId) INCLUDE (AggregateId);
