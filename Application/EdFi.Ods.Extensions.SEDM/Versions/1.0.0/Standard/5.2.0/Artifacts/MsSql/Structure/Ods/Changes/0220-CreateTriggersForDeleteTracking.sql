...
BEGIN
    ...
    INSERT INTO [tracked_changes_sedm].[StudentIEPAccommodationCollection](OldIEPFinalizedDate, OldIEPServicingEducationOrganizationId, OldStudentIEPAssociationID, OldStudentUSI, OldStudentUniqueId, Id, Discriminator, ChangeVersion)
    SELECT d.IEPFinalizedDate, d.IEPServicingEducationOrganizationId, d.StudentIEPAssociationID, d.StudentUSI, j0.StudentUniqueId, d.Id, d.Discriminator, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
        INNER JOIN edfi.Student j0
            ON d.StudentUSI = j0.StudentUSI
...
BEGIN
    ...
    INSERT INTO [tracked_changes_sedm].[StudentIEPDisabilityCollection](OldIEPFinalizedDate, OldIEPServicingEducationOrganizationId, OldStudentIEPAssociationID, OldStudentUSI, OldStudentUniqueId, Id, Discriminator, ChangeVersion)
    SELECT d.IEPFinalizedDate, d.IEPServicingEducationOrganizationId, d.StudentIEPAssociationID, d.StudentUSI, j0.StudentUniqueId, d.Id, d.Discriminator, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
        INNER JOIN edfi.Student j0
            ON d.StudentUSI = j0.StudentUSI
