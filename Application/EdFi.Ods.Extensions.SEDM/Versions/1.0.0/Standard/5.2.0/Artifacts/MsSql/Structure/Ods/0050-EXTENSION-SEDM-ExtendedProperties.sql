...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Indicates service provider type, including specialist, internal staff, external staff, etc.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'ServiceProviderTypeDescriptor'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'ServiceProviderTypeDescriptor', @level2type=N'COLUMN', @level2name=N'ServiceProviderTypeDescriptorId'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This association describes summary IEP data for a student receiving special education services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'IEPFinalizedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider or source system of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'StudentIEPAssociationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date when the most recent IEP was last amended, if any.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'IEPAmendedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The effective start date of the most recent IEP.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'IEPBeginDate'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Indicates whether the student receiving special education and related services has been designated as multiply disabled by the admission, review, and dismissal committee as aligned with federal requirements.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'MultiplyDisabled'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The reason the student left and stop receiving special education services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'ReasonExitedDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Indicates the total number of hours of instructional time per week for the school that the student attends.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'SchoolHoursPerWeek'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Indicates the total number of hours of time per week specific to special education related services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'SpecialEducationHoursPerWeek'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The major instructional setting (more than 50 percent of a student''s special education program).', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEP', @level2type=N'COLUMN', @level2name=N'SpecialEducationSettingDescriptorId'
GO

-- Extended Properties [sedm].[StudentIEPAccommodationCollection] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The accommodations prescribed to a student as part of their IEP.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollection'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollection', @level2type=N'COLUMN', @level2name=N'IEPFinalizedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollection', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider or source system of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollection', @level2type=N'COLUMN', @level2name=N'StudentIEPAssociationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollection', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO

-- Extended Properties [sedm].[StudentIEPAccommodationCollectionIEPAccommodation] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The special variation(s) to be used in how various services (in general) are presented, how they are administered, or how the student is allowed to respond. This generally refers to changes that do not substantially alter the content that the service renders. The proper use of accommodations does not substantially change academic level or performance criteria.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollectionIEPAccommodation'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollectionIEPAccommodation', @level2type=N'COLUMN', @level2name=N'IEPFinalizedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollectionIEPAccommodation', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider or source system of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollectionIEPAccommodation', @level2type=N'COLUMN', @level2name=N'StudentIEPAssociationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollectionIEPAccommodation', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The special variation(s) to be used in how various services (in general) are presented, how they are administered, or how the student is allowed to respond. This generally refers to changes that do not substantially alter the content that the service renders. The proper use of accommodations does not substantially change academic level or performance criteria.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPAccommodationCollectionIEPAccommodation', @level2type=N'COLUMN', @level2name=N'AccommodationDescriptorId'
GO

-- Extended Properties [sedm].[StudentIEPDisabilityCollection] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The disabilities prescribed to a student as part of their IEP.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollection'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollection', @level2type=N'COLUMN', @level2name=N'IEPFinalizedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollection', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider or source system of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollection', @level2type=N'COLUMN', @level2name=N'StudentIEPAssociationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollection', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO

-- Extended Properties [sedm].[StudentIEPDisabilityCollectionDisability] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The disability condition(s) that best describes an individual''s impairment, as related to special education services received.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability', @level2type=N'COLUMN', @level2name=N'IEPFinalizedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider or source system of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability', @level2type=N'COLUMN', @level2name=N'StudentIEPAssociationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A disability category that describes a individual''s impairment.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability', @level2type=N'COLUMN', @level2name=N'DisabilityDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The source that provided the disability determination.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability', @level2type=N'COLUMN', @level2name=N'DisabilityDeterminationSourceTypeDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A description of the disability diagnosis.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability', @level2type=N'COLUMN', @level2name=N'DisabilityDiagnosis'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The order by severity of individual''s disabilities: 1- Primary, 2 -  Secondary, 3 - Tertiary, etc.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisability', @level2type=N'COLUMN', @level2name=N'OrderOfDisability'
GO

-- Extended Properties [sedm].[StudentIEPDisabilityCollectionDisabilityDesignation] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Whether the disability is IDEA, Section 504, or other disability designation.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisabilityDesignation'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisabilityDesignation', @level2type=N'COLUMN', @level2name=N'IEPFinalizedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisabilityDesignation', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider or source system of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisabilityDesignation', @level2type=N'COLUMN', @level2name=N'StudentIEPAssociationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisabilityDesignation', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A disability category that describes a individual''s impairment.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisabilityDesignation', @level2type=N'COLUMN', @level2name=N'DisabilityDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Whether the disability is IDEA, Section 504, or other disability designation.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPDisabilityCollectionDisabilityDesignation', @level2type=N'COLUMN', @level2name=N'DisabilityDesignationDescriptorId'
GO

-- Extended Properties [sedm].[StudentIEPGoal] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A goal prescribed to a student as part of their IEP.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPGoal'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPGoal', @level2type=N'COLUMN', @level2name=N'IEPFinalizedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPGoal', @level2type=N'COLUMN', @level2name=N'IEPGoalID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPGoal', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider or source system of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPGoal', @level2type=N'COLUMN', @level2name=N'StudentIEPAssociationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPGoal', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The first date of the period assigned for achieving the stated goal.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPGoal', @level2type=N'COLUMN', @level2name=N'GoalAchievementPeriodBeginDate'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPGoalIDEAEvent', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPIDEAEvent', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Services delivered to a student as prescribed by their IEP.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDelivery'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDelivery', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The type of service prescribed. Examples include: Auditory Specialist, Vocational Therapy.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDelivery', @level2type=N'COLUMN', @level2name=N'ServicePrescriptionDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryExternalServiceProvider', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A code assigned to the external service provider.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryExternalServiceProvider', @level2type=N'COLUMN', @level2name=N'ProviderCode'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The first name of the external service provider.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryExternalServiceProvider', @level2type=N'COLUMN', @level2name=N'ProviderFirstName'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The last name of the external service provider.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryExternalServiceProvider', @level2type=N'COLUMN', @level2name=N'ProviderLastSurname'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Primary External Service Provider.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryExternalServiceProvider', @level2type=N'COLUMN', @level2name=N'PrimaryProvider'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryIDEAEvent', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The internal service provider that delivered the prescribed service to the student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryServiceProvider'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryServiceProvider', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a staff.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryServiceProvider', @level2type=N'COLUMN', @level2name=N'StaffUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Primary ServiceProvider.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServiceDeliveryServiceProvider', @level2type=N'COLUMN', @level2name=N'PrimaryProvider'
GO

-- Extended Properties [sedm].[StudentIEPServicePrescription] --
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The service prescribed to a student as part of their IEP.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescription'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescription', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The effective date when service is to begin.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescription', @level2type=N'COLUMN', @level2name=N'BeginDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The length of time for the prescribed service in minutes.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescription', @level2type=N'COLUMN', @level2name=N'DurationMinutes'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The frequency period for the prescribed service duration. Examples include: Per Session, Per Week, Per Month.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescription', @level2type=N'COLUMN', @level2name=N'DurationPeriodDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The effective date when the prescribed service ended.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescription', @level2type=N'COLUMN', @level2name=N'EndDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The frequency period for the prescribed service. Examples include: Session, Week, Month.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescription', @level2type=N'COLUMN', @level2name=N'FrequencyPeriodDescriptorId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescription', @level2type=N'COLUMN', @level2name=N'ServiceProvidingEducationOrganizationId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'StudentIEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
