...
COMMENT ON COLUMN sedm.StudentIEPAccommodationCollection.IEPServicingEducationOrganizationId IS 'The identifier assigned to an education organization.';
...
COMMENT ON TABLE sedm.StudentIEPAccommodationCollectionIEPAccommodation IS 'The special variation(s) to be used in how various services (in general) are presented, how they are administered, or how the student is allowed to respond. This generally refers to changes that do not substantially alter the content that the service renders. The proper use of accommodations does not substantially change academic level or performance criteria.';
COMMENT ON COLUMN sedm.StudentIEPAccommodationCollectionIEPAccommodation.IEPFinalizedDate IS 'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.';
COMMENT ON COLUMN sedm.StudentIEPAccommodationCollectionIEPAccommodation.IEPServicingEducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN sedm.StudentIEPAccommodationCollectionIEPAccommodation.StudentIEPAssociationID IS 'A unique identifier assigned by the provider or source system of IEP services.';
COMMENT ON COLUMN sedm.StudentIEPAccommodationCollectionIEPAccommodation.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
...
COMMENT ON COLUMN sedm.StudentIEPDisabilityCollection.IEPServicingEducationOrganizationId IS 'The identifier assigned to an education organization.';
...
COMMENT ON COLUMN sedm.StudentIEPDisabilityCollectionDisability.IEPServicingEducationOrganizationId IS 'The identifier assigned to an education organization.';
...
COMMENT ON COLUMN sedm.StudentIEPDisabilityCollectionDisabilityDesignation.IEPServicingEducationOrganizationId IS 'The identifier assigned to an education organization.';
...
COMMENT ON COLUMN sedm.StudentIEPServicePrescription.IEPServicingEducationOrganizationId IS 'The identifier assigned to an education organization.';
...
COMMENT ON COLUMN sedm.StudentIEPServicePrescription.ServiceProvidingEducationOrganizationId IS 'The identifier assigned to an education organization.';
COMMENT ON COLUMN sedm.StudentIEPServicePrescription.StaffUSI IS 'A unique alphanumeric code assigned to a staff.';
...
COMMENT ON COLUMN sedm.StudentIEPServicePrescriptionIDEAEvent.IEPServicingEducationOrganizationId IS 'The identifier assigned to an education organization.';
