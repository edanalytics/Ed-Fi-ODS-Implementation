...
(
       ...
       oldideaeventid VARCHAR(128) NOT NULL,
       ...
       newideaeventid VARCHAR(128) NULL,
...
(
       ...
       oldstudentiepassociationid VARCHAR(128) NOT NULL,
       oldstudentusi INT NOT NULL,
       oldstudentuniqueid VARCHAR(32) NOT NULL,
       neweducationorganizationid BIGINT NULL,
       newiepfinalizeddate DATE NULL,
       newstudentiepassociationid VARCHAR(128) NULL,
       newstudentusi INT NULL,
       newstudentuniqueid VARCHAR(32) NULL,
       id uuid NOT NULL,
       changeversion bigint NOT NULL,
...
(
       oldeducationorganizationid BIGINT NOT NULL,
       oldiepfinalizeddate DATE NOT NULL,
       oldiepgoalid VARCHAR(128) NOT NULL,
       oldstudentiepassociationid VARCHAR(128) NOT NULL,
       oldstudentusi INT NOT NULL,
       oldstudentuniqueid VARCHAR(32) NOT NULL,
       neweducationorganizationid BIGINT NULL,
       newiepfinalizeddate DATE NULL,
       newiepgoalid VARCHAR(128) NULL,
       newstudentiepassociationid VARCHAR(128) NULL,
       newstudentusi INT NULL,
       newstudentuniqueid VARCHAR(32) NULL,
       id uuid NOT NULL,
...
(
       oldeducationorganizationid BIGINT NOT NULL,
       oldiepfinalizeddate DATE NOT NULL,
       oldiepservicedeliveryid VARCHAR(128) NOT NULL,
       ...
       neweducationorganizationid BIGINT NULL,
       newiepfinalizeddate DATE NULL,
       newiepservicedeliveryid VARCHAR(128) NULL,
