...
CREATE TABLE sedm.StudentIEPAccommodationCollection (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT StudentIEPAccommodationCollection_PK PRIMARY KEY (IEPFinalizedDate, IEPServicingEducationOrganizationId, StudentIEPAssociationID, StudentUSI)
);
...
CREATE TABLE sedm.StudentIEPAccommodationCollectionIEPAccommodation (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentIEPAccommodationCollectionIEPAccommodation_PK PRIMARY KEY (IEPFinalizedDate, IEPServicingEducationOrganizationId, StudentIEPAssociationID, StudentUSI, AccommodationDescriptorId)
);
ALTER TABLE sedm.StudentIEPAccommodationCollectionIEPAccommodation ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
CREATE TABLE sedm.StudentIEPDisabilityCollection (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT StudentIEPDisabilityCollection_PK PRIMARY KEY (IEPFinalizedDate, IEPServicingEducationOrganizationId, StudentIEPAssociationID, StudentUSI)
);
...
CREATE TABLE sedm.StudentIEPDisabilityCollectionDisability (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentIEPDisabilityCollectionDisability_PK PRIMARY KEY (IEPFinalizedDate, IEPServicingEducationOrganizationId, StudentIEPAssociationID, StudentUSI, DisabilityDescriptorId)
);
...
CREATE TABLE sedm.StudentIEPDisabilityCollectionDisabilityDesignation (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentIEPDisabilityCollectionDisabilityDesignation_PK PRIMARY KEY (IEPFinalizedDate, IEPServicingEducationOrganizationId, StudentIEPAssociationID, StudentUSI, DisabilityDescriptorId, DisabilityDesignationDescriptorId)
);
...
CREATE TABLE sedm.StudentIEPServicePrescription (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT StudentIEPServicePrescription_PK PRIMARY KEY (IEPFinalizedDate, IEPServicingEducationOrganizationId, ServicePrescriptionDate, ServicePrescriptionDescriptorId, StudentIEPAssociationID, StudentUSI)
);
...
CREATE TABLE sedm.StudentIEPServicePrescriptionIDEAEvent (
    ...
    IDEAEventID VARCHAR(1024) NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentIEPServicePrescriptionIDEAEvent_PK PRIMARY KEY (IEPFinalizedDate, IEPServicingEducationOrganizationId, ServicePrescriptionDate, ServicePrescriptionDescriptorId, StudentIEPAssociationID, StudentUSI, EducationOrganizationId, IDEAEventDescriptorId, IDEAEventID)
);
