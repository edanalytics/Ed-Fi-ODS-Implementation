...
CREATE INDEX IF NOT EXISTS IX_StudentIEPServicePrescription_IEPServicingEducationOrganizationId ON sedm.StudentIEPServicePrescription(IEPServicingEducationOrganizationId) INCLUDE (Id);
