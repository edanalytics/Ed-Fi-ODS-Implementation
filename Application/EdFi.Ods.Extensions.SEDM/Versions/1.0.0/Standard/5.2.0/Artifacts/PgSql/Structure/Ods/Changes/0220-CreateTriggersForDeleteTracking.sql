...
BEGIN
    ...
    INSERT INTO tracked_changes_sedm.studentiep(
        oldeducationorganizationid, oldiepfinalizeddate, oldstudentiepassociationid, oldstudentusi, oldstudentuniqueid,
        id, discriminator, changeversion)
    VALUES (
        OLD.educationorganizationid, OLD.iepfinalizeddate, OLD.studentiepassociationid, OLD.studentusi, dj0.studentuniqueid, 
        OLD.id, OLD.discriminator, nextval('changes.changeversionsequence'));
...
CREATE OR REPLACE FUNCTION tracked_changes_sedm.studentiepaccommodationcollection_deleted()
    RETURNS trigger AS
$BODY$
DECLARE
    dj0 edfi.student%ROWTYPE;
BEGIN
    ...
    INSERT INTO tracked_changes_sedm.studentiepaccommodationcollection(
        oldeducationorganizationid, oldiepfinalizeddate, oldstudentiepassociationid, oldstudentusi, oldstudentuniqueid,
        id, discriminator, changeversion)
    VALUES (
        OLD.educationorganizationid, OLD.iepfinalizeddate, OLD.studentiepassociationid, OLD.studentusi, dj0.studentuniqueid, 
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'sedm' AND event_object_table = 'studentiepaccommodationcollection') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON sedm.studentiepaccommodationcollection 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_sedm.studentiepaccommodationcollection_deleted();
END IF;

CREATE OR REPLACE FUNCTION tracked_changes_sedm.studentiepdisabilitycollection_deleted()
    RETURNS trigger AS
$BODY$
DECLARE
    dj0 edfi.student%ROWTYPE;
BEGIN
    ...
    INSERT INTO tracked_changes_sedm.studentiepdisabilitycollection(
        oldeducationorganizationid, oldiepfinalizeddate, oldstudentiepassociationid, oldstudentusi, oldstudentuniqueid,
        id, discriminator, changeversion)
    VALUES (
        OLD.educationorganizationid, OLD.iepfinalizeddate, OLD.studentiepassociationid, OLD.studentusi, dj0.studentuniqueid, 
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'sedm' AND event_object_table = 'studentiepdisabilitycollection') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON sedm.studentiepdisabilitycollection 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_sedm.studentiepdisabilitycollection_deleted();
END IF;
...
BEGIN
    ...
    INSERT INTO tracked_changes_sedm.studentiepgoal(
        oldeducationorganizationid, oldiepfinalizeddate, oldiepgoalid, oldstudentiepassociationid, oldstudentusi, oldstudentuniqueid,
        id, discriminator, changeversion)
    VALUES (
        OLD.educationorganizationid, OLD.iepfinalizeddate, OLD.iepgoalid, OLD.studentiepassociationid, OLD.studentusi, dj0.studentuniqueid, 
        OLD.id, OLD.discriminator, nextval('changes.changeversionsequence'));
...
CREATE OR REPLACE FUNCTION tracked_changes_sedm.studentiepserviceprescription_deleted()
    RETURNS trigger AS
$BODY$
DECLARE
    dj0 edfi.descriptor%ROWTYPE;
...
IF NOT EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trackdeletes' AND event_object_schema = 'sedm' AND event_object_table = 'studentiepserviceprescription') THEN
CREATE TRIGGER TrackDeletes AFTER DELETE ON sedm.studentiepserviceprescription 
    FOR EACH ROW EXECUTE PROCEDURE tracked_changes_sedm.studentiepserviceprescription_deleted();
END IF;
